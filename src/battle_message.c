...
const u16 gWrappedStringIds[] =
{
    ...
    STRINGID_PKMNTRAPPEDINVORTEX,  // MOVE_FIRESPIN
    STRINGID_PKMNCLAMPED,          // MOVE_CLAMP
    STRINGID_PKMNTRAPPEDINVORTEX,  // MOVE_WHIRLPOOL
    STRINGID_PKMNTRAPPEDBYSANDTOMB // MOVE_SANDTOMB
};
...
{
    MOVE_SWORDSDANCE, MOVE_STRENGTH, MOVE_GROWTH,
    MOVE_HARDEN, MOVE_MINIMIZE, MOVE_SMOKESCREEN,
    MOVE_WITHDRAW, MOVE_DEFENSECURL, MOVE_EGGBOMB,
    MOVE_SMOG, MOVE_BONECLUB, MOVE_FLASH, MOVE_SPLASH,
    MOVE_ACIDARMOR, MOVE_BONEMERANG, MOVE_REST, MOVE_SHARPEN,
    MOVE_SUBSTITUTE, MOVE_MINDREADER, MOVE_SNORE,
    MOVE_PROTECT, MOVE_SPIKES, MOVE_ENDURE, MOVE_ROLLOUT,
    MOVE_SWAGGER, MOVE_SLEEPTALK, MOVE_HIDDENPOWER,
    MOVE_PSYCHUP, MOVE_EXTREMESPEED, MOVE_FOLLOWME,
    MOVE_TRICK, MOVE_ASSIST, MOVE_INGRAIN, MOVE_KNOCKOFF,
    MOVE_CAMOUFLAGE, MOVE_ASTONISH, MOVE_ODORSLEUTH,
    MOVE_GRASSWHISTLE, MOVE_SHEERCOLD, MOVE_MUDDYWATER,
    MOVE_IRONDEFENSE, MOVE_BOUNCE, 0,

    MOVE_TELEPORT, MOVE_RECOVER, MOVE_BIDE, MOVE_AMNESIA,
    MOVE_FLAIL, MOVE_TAUNT, MOVE_BULKUP, 0,

    MOVE_MEDITATE, MOVE_AGILITY, MOVE_MIMIC, MOVE_DOUBLETEAM,
    MOVE_BARRAGE, MOVE_TRANSFORM, MOVE_STRUGGLE, MOVE_SCARYFACE,
    MOVE_CHARGE, MOVE_WISH, MOVE_BRICKBREAK, MOVE_YAWN,
    MOVE_FEATHERDANCE, MOVE_TEETERDANCE, MOVE_MUDSPORT,
    MOVE_FAKETEARS, MOVE_WATERSPORT, MOVE_CALMMIND, 0,

    MOVE_POUND, MOVE_SCRATCH, MOVE_VICEGRIP,
    MOVE_WINGATTACK, MOVE_FLY, MOVE_BIND, MOVE_SLAM,
    MOVE_HORNATTACK, MOVE_WRAP, MOVE_THRASH, MOVE_TAILWHIP,
    MOVE_LEER, MOVE_BITE, MOVE_GROWL, MOVE_ROAR,
    MOVE_SING, MOVE_PECK, MOVE_ABSORB, MOVE_STRINGSHOT,
    MOVE_EARTHQUAKE, MOVE_FISSURE, MOVE_DIG, MOVE_TOXIC,
    MOVE_SCREECH, MOVE_METRONOME, MOVE_LICK, MOVE_CLAMP,
    MOVE_CONSTRICT, MOVE_POISONGAS, MOVE_BUBBLE,
    MOVE_SLASH, MOVE_SPIDERWEB, MOVE_NIGHTMARE, MOVE_CURSE,
    MOVE_FORESIGHT, MOVE_CHARM, MOVE_ATTRACT, MOVE_ROCKSMASH,
    MOVE_UPROAR, MOVE_SPITUP, MOVE_SWALLOW, MOVE_TORMENT,
    MOVE_FLATTER, MOVE_ROLEPLAY, MOVE_ENDEAVOR, MOVE_TICKLE,
    MOVE_COVET, 0
};
