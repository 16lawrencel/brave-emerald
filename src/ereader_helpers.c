...
static const struct TrainerHillTrainer sTrainerHillTrainerTemplates_JP[] = {
    [0] = {
        ...
        .speechWin = { EC_WORD_HERS, EC_WORD_TRUMP_CARD, EC_MOVE2(SECRETPOWER), EC_WORD_USING, EC_WORD_WON, EC_WORD_EXCL_EXCL },
        ...
        .mons = {
            ...
            [3] = {
                ...
                .moves = { MOVE_SLUDGEBOMB, MOVE_SHADOWBALL, MOVE_PAINSPLIT, MOVE_YAWN },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 55,
                .attackEV = 255,
            ...
            [4] = {
                ...
                .moves = { MOVE_SILVERWIND, MOVE_SLUDGEBOMB, MOVE_SHADOWBALL, MOVE_GIGADRAIN },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 0,
                .attackEV = 255,
            ...
            [5] = {
                ...
                .moves = { MOVE_ANCIENTPOWER, MOVE_SURF, MOVE_EARTHQUAKE, MOVE_AMNESIA },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 100,
                .attackEV = 0,
    ...
    [1] = {
        ...
        .mons = {
            ...
            [3] = {
                ...
                .heldItem = ITEM_QUICK_CLAW,
                .moves = { MOVE_GIGADRAIN, MOVE_FEINTATTACK, MOVE_THUNDERPUNCH, MOVE_GROWTH },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 55,
                .attackEV = 0,
            ...
            [4] = {
                ...
                .heldItem = ITEM_BRIGHT_POWDER,
                .moves = { MOVE_FACADE, MOVE_AERIALACE, MOVE_QUICKATTACK, MOVE_DOUBLETEAM },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 255,
                .attackEV = 255,
    ...
    [2] = {
        ...
        .mons = {
            ...
            [3] = {
                ...
                .moves = { MOVE_SING, MOVE_BODYSLAM, MOVE_SHADOWBALL, MOVE_IRONTAIL },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 0,
                .attackEV = 255,
            ...
            [4] = {
                ...
                .moves = { MOVE_GIGADRAIN, MOVE_GRASSWHISTLE, MOVE_TOXIC, MOVE_LEECHSEED },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 255,
                .attackEV = 0,
            ...
            [5] = {
                ...
                .heldItem = ITEM_BRIGHT_POWDER,
                .moves = { MOVE_SILVERWIND, MOVE_AERIALACE, MOVE_ATTRACT, MOVE_PSYCHIC },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 100,
                .attackEV = 200,
    ...
    [3] = {
        ...
        .mons = {
            ...
            [3] = {
                ...
                .heldItem = ITEM_BRIGHT_POWDER,
                .moves = { MOVE_CRUNCH, MOVE_FLAMETHROWER, MOVE_THUNDERPUNCH, MOVE_COMETPUNCH },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 0,
                .attackEV = 0,
            ...
            [4] = {
                ...
                .moves = { MOVE_SURF, MOVE_CRUNCH, MOVE_DOUBLEEDGE, MOVE_EARTHQUAKE },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 255,
                .attackEV = 0,
            ...
            [5] = {
                ...
                .heldItem = ITEM_LUM_BERRY,
                .moves = { MOVE_PSYCHIC, MOVE_SHADOWBALL, MOVE_THUNDERBOLT, MOVE_WILLOWISP },
                .level = 0,
                .ppBonuses = 0x0,
                .hpEV = 255,
                .attackEV = 0,
