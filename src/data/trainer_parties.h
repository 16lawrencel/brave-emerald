...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    ...
    .moves = {MOVE_SKILLSWAP, MOVE_EARTHQUAKE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_SANDATTACK, MOVE_POISONSTING}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = {MOVE_PSYBEAM, MOVE_SELFDESTRUCT, MOVE_SANDSTORM, MOVE_ANCIENTPOWER}
    },
    {
    .iv = 50,
    .lvl = 27,
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 39,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_SONICBOOM, MOVE_THUNDERWAVE, MOVE_METALSOUND, MOVE_THUNDERBOLT}
    },
    {
    .iv = 250,
    .lvl = 39,
    .species = SPECIES_EXPLOUD,
    .moves = {MOVE_ASTONISH, MOVE_STOMP, MOVE_SUPERSONIC, MOVE_HYPERVOICE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky1[] = {
    ...
    .lvl = 13,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_SANDATTACK, MOVE_HEADBUTT, MOVE_TAILWHIP, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky2[] = {
    ...
    .moves = {MOVE_SANDATTACK, MOVE_PINMISSILE, MOVE_TAILWHIP, MOVE_SURF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICKATTACK, MOVE_AGILITY, MOVE_WINGATTACK, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TEETERDANCE, MOVE_DIZZYPUNCH, MOVE_FOCUSPUNCH, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .moves = {MOVE_SLACKOFF, MOVE_COUNTER, MOVE_SHADOWBALL, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUSENERGY, MOVE_SLASH, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .lvl = 28,
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_FOCUSENERGY, MOVE_QUICKATTACK, MOVE_WINGATTACK, MOVE_ENDEAVOR}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_TRAPINCH,
    .moves = {MOVE_BITE, MOVE_DIG, MOVE_FEINTATTACK, MOVE_SANDTOMB}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_WAILMER,
    .moves = {MOVE_ROLLOUT, MOVE_WHIRLPOOL, MOVE_ASTONISH, MOVE_WATERPULSE}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_THUNDERBOLT, MOVE_SUPERSONIC, MOVE_THUNDERWAVE, MOVE_SONICBOOM}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_SHIFTRY,
    .moves = {MOVE_GIGADRAIN, MOVE_FEINTATTACK, MOVE_DOUBLETEAM, MOVE_SWAGGER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FEINTATTACK, MOVE_SHOCKWAVE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSECURL, MOVE_DOUBLEEDGE, MOVE_SHADOWBALL, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDSDANCE, MOVE_SLASH, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .lvl = 29,
    .species = SPECIES_MAWILE,
    .moves = {MOVE_BATONPASS, MOVE_FEINTATTACK, MOVE_FAKETEARS, MOVE_BITE}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_MEGADRAIN, MOVE_MAGICALLEAF, MOVE_GRASSWHISTLE, MOVE_LEECHSEED}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_PELIPPER,
    .moves = {MOVE_FLY, MOVE_WATERGUN, MOVE_MIST, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SWEETKISS, MOVE_FLAIL, MOVE_WATERPULSE}
    },
    {
    .iv = 100,
    .lvl = 39,
    .species = SPECIES_LUVDISC,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SAFEGUARD, MOVE_TAKEDOWN, MOVE_WATERPULSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_FURYSWIPES, MOVE_MUDSPORT, MOVE_ODORSLEUTH, MOVE_SANDATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica1[] = {
    ...
    .lvl = 29,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_BIND, MOVE_LICK, MOVE_FURYSWIPES, MOVE_FEINTATTACK}
    },
    {
    .iv = 0,
    .lvl = 29,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_POISONTAIL, MOVE_SCREECH, MOVE_GLARE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .moves = {MOVE_IRONDEFENSE, MOVE_WHIRLPOOL, MOVE_RAINDANCE, MOVE_WATERPULSE}
    },
    {
    .iv = 100,
    .lvl = 37,
    .species = SPECIES_CORPHISH,
    .moves = {MOVE_TAUNT, MOVE_CRABHAMMER, MOVE_WATERPULSE, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 39,
    .species = SPECIES_LOMBRE,
    .moves = {MOVE_UPROAR, MOVE_FURYSWIPES, MOVE_FAKEOUT, MOVE_WATERPULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .lvl = 17,
    .species = SPECIES_ELECTRIKE,
    .moves = {MOVE_QUICKATTACK, MOVE_THUNDERWAVE, MOVE_SPARK, MOVE_LEER}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_VOLTORB,
    .moves = {MOVE_CHARGE, MOVE_SHOCKWAVE, MOVE_SCREECH, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .lvl = 23,
    .species = SPECIES_SANDSHREW,
    .moves = {MOVE_DIG, MOVE_SANDATTACK, MOVE_POISONSTING, MOVE_SLASH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .lvl = 21,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_RAPIDSPIN, MOVE_MUDSLAP, MOVE_PSYBEAM, MOVE_ROCKTOMB}
    },
    {
    .iv = 0,
    .lvl = 21,
    .species = SPECIES_SANDSHREW,
    .moves = {MOVE_POISONSTING, MOVE_SANDATTACK, MOVE_SCRATCH, MOVE_DIG}
    },
    {
    .iv = 0,
    .lvl = 21,
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter3[] = {
    ...
    .lvl = 36,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_HEADBUTT, MOVE_SANDATTACK, MOVE_ODORSLEUTH, MOVE_FURYSWIPES}
    },
    {
    .iv = 20,
    .lvl = 36,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_QUICKATTACK, MOVE_SPARK, MOVE_ODORSLEUTH, MOVE_ROAR}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter4[] = {
    ...
    .lvl = 39,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_QUICKATTACK, MOVE_SPARK, MOVE_ODORSLEUTH, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter5[] = {
    ...
    .moves = {MOVE_FURYSWIPES, MOVE_DISABLE, MOVE_CONFUSION, MOVE_PSYCHUP}
    },
    {
    .iv = 40,
    .lvl = 41,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROAR, MOVE_DOUBLEEDGE, MOVE_SANDATTACK, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 48,
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TORMENT, MOVE_DOUBLETEAM, MOVE_SWAGGER, MOVE_EXTRASENSORY}
    },
    {
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_CACTURNE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEECHSEED, MOVE_FEINTATTACK, MOVE_NEEDLEARM, MOVE_COTTONSPORE}
    },
    {
    .iv = 250,
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_SWORDSDANCE, MOVE_STRENGTH, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AERIALACE, MOVE_ROCKSLIDE, MOVE_SWORDSDANCE, MOVE_SLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOWPUNCH, MOVE_CONFUSERAY, MOVE_CURSE, MOVE_PROTECT}
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOWBALL, MOVE_GRUDGE, MOVE_WILLOWISP, MOVE_FEINTATTACK}
    },
    {
    .iv = 250,
    .lvl = 50,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOWBALL, MOVE_DOUBLETEAM, MOVE_NIGHTSHADE, MOVE_FEINTATTACK}
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOWBALL, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOWBALL, MOVE_ICEBEAM, MOVE_ROCKSLIDE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .species = SPECIES_SEALEO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENCORE, MOVE_BODYSLAM, MOVE_HAIL, MOVE_ICEBALL}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIGHTSCREEN, MOVE_CRUNCH, MOVE_ICYWIND, MOVE_ICEBEAM}
    },
    {
    .iv = 250,
    .lvl = 52,
    .species = SPECIES_SEALEO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ATTRACT, MOVE_DOUBLEEDGE, MOVE_HAIL, MOVE_BLIZZARD}
    },
    {
    .iv = 250,
    .lvl = 52,
    .species = SPECIES_GLALIE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOWBALL, MOVE_EXPLOSION, MOVE_HAIL, MOVE_ICEBEAM}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_BODYSLAM, MOVE_ICEBEAM, MOVE_SHEERCOLD}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCKTOMB, MOVE_DRAGONCLAW, MOVE_PROTECT, MOVE_DOUBLEEDGE}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLEEDGE, MOVE_DRAGONBREATH, MOVE_DRAGONDANCE, MOVE_AERIALACE}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SMOKESCREEN, MOVE_DRAGONDANCE, MOVE_SURF, MOVE_BODYSLAM}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_DRAGONBREATH, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGONCLAW, MOVE_ROCKSLIDE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_GEODUDE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_DEFENSECURL, MOVE_ROCKTHROW, MOVE_ROCKTOMB}
    },
    {
    .iv = 200,
    .lvl = 18,
    ...
    .moves = {MOVE_BLOCK, MOVE_HARDEN, MOVE_TACKLE, MOVE_ROCKTOMB}
    },
    {
    .iv = 100,
    .lvl = 15,
    ...
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_ROCKTOMB, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCRATCH, MOVE_ROCKTOMB, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSERAY, MOVE_ROCKTOMB, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KARATECHOP, MOVE_LOWKICK, MOVE_SEISMICTOSS, MOVE_BULKUP}
    },
    {
    .iv = 100,
    .lvl = 16,
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUSPUNCH, MOVE_LIGHTSCREEN, MOVE_REFLECT, MOVE_BULKUP}
    },
    {
    .iv = 200,
    .lvl = 19,
    .species = SPECIES_MAKUHITA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ARMTHRUST, MOVE_VITALTHROW, MOVE_REVERSAL, MOVE_BULKUP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_VOLTORB,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROLLOUT, MOVE_SPARK, MOVE_SELFDESTRUCT, MOVE_SHOCKWAVE}
    },
    {
    .iv = 200,
    .lvl = 20,
    .species = SPECIES_ELECTRIKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCKWAVE, MOVE_LEER, MOVE_QUICKATTACK, MOVE_HOWL}
    },
    {
    .iv = 220,
    .lvl = 22,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUPERSONIC, MOVE_SHOCKWAVE, MOVE_THUNDERWAVE, MOVE_SONICBOOM}
    },
    {
    .iv = 250,
    .lvl = 24,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICKATTACK, MOVE_THUNDERWAVE, MOVE_SHOCKWAVE, MOVE_HOWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_NUMEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_TAKEDOWN, MOVE_MAGNITUDE, MOVE_SUNNYDAY}
    },
    {
    .iv = 200,
    .lvl = 24,
    .species = SPECIES_SLUGMA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_SMOG, MOVE_LIGHTSCREEN, MOVE_SUNNYDAY}
    },
    {
    .iv = 250,
    .lvl = 26,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_TACKLE, MOVE_SUNNYDAY, MOVE_ATTRACT}
    },
    {
    .iv = 250,
    .lvl = 29,
    ...
    .moves = {MOVE_OVERHEAT, MOVE_SUNNYDAY, MOVE_BODYSLAM, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_SPINDA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TEETERDANCE, MOVE_PSYBEAM, MOVE_FACADE, MOVE_ENCORE}
    },
    {
    .iv = 200,
    .lvl = 27,
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLASH, MOVE_FACADE, MOVE_ENCORE, MOVE_FEINTATTACK}
    },
    {
    .iv = 200,
    .lvl = 29,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLASH, MOVE_BELLYDRUM, MOVE_FACADE, MOVE_HEADBUTT}
    },
    {
    .iv = 250,
    .lvl = 31,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_COUNTER, MOVE_YAWN, MOVE_FACADE, MOVE_FEINTATTACK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PERISHSONG, MOVE_MIRRORMOVE, MOVE_SAFEGUARD, MOVE_AERIALACE}
    },
    {
    .iv = 210,
    .lvl = 29,
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNYDAY, MOVE_AERIALACE, MOVE_SOLARBEAM, MOVE_SYNTHESIS}
    },
    {
    .iv = 210,
    .lvl = 30,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATERGUN, MOVE_SUPERSONIC, MOVE_PROTECT, MOVE_AERIALACE}
    },
    {
    .iv = 220,
    .lvl = 31,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SANDATTACK, MOVE_FURYATTACK, MOVE_STEELWING, MOVE_AERIALACE}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGONBREATH, MOVE_DRAGONDANCE, MOVE_AERIALACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_ANCIENTPOWER, MOVE_PSYCHIC, MOVE_LIGHTSCREEN}
    },
    {
    .iv = 250,
    .lvl = 41,
    .species = SPECIES_XATU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_SUNNYDAY, MOVE_CONFUSERAY, MOVE_CALMMIND}
    },
    {
    .iv = 250,
    .lvl = 42,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LIGHTSCREEN, MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_CALMMIND}
    },
    {
    .iv = 250,
    .lvl = 42,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUNNYDAY, MOVE_SOLARBEAM, MOVE_PSYCHIC, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_LUVDISC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATERPULSE, MOVE_ATTRACT, MOVE_SWEETKISS, MOVE_FLAIL}
    },
    {
    .iv = 200,
    .lvl = 41,
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAINDANCE, MOVE_WATERPULSE, MOVE_AMNESIA, MOVE_EARTHQUAKE}
    },
    {
    .iv = 200,
    .lvl = 43,
    .species = SPECIES_SEALEO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENCORE, MOVE_BODYSLAM, MOVE_AURORABEAM, MOVE_WATERPULSE}
    },
    {
    .iv = 200,
    .lvl = 43,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATERPULSE, MOVE_CRABHAMMER, MOVE_TAUNT, MOVE_LEER}
    },
    {
    .iv = 250,
    .lvl = 46,
    ...
    .moves = {MOVE_WATERPULSE, MOVE_DOUBLETEAM, MOVE_ICEBEAM, MOVE_REST}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_KateAndJoy[] = {
    ...
    .lvl = 30,
    .species = SPECIES_SPINDA,
    .moves = {MOVE_HYPNOSIS, MOVE_PSYBEAM, MOVE_DIZZYPUNCH, MOVE_TEETERDANCE}
    },
    {
    .iv = 0,
    .lvl = 32,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_FOCUSPUNCH, MOVE_YAWN, MOVE_SLACKOFF, MOVE_FEINTATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 15,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_GROWL, MOVE_TAILWHIP, MOVE_HEADBUTT, MOVE_ODORSLEUTH}
    },
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_MAKUHITA,
    .moves = {MOVE_TACKLE, MOVE_FOCUSENERGY, MOVE_ARMTHRUST, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Colton[] = {
    ...
    .species = SPECIES_SKITTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ASSIST, MOVE_CHARM, MOVE_FEINTATTACK, MOVE_HEALBELL}
    },
    {
    .iv = 0,
    .lvl = 36,
...
static const struct TrainerMonNoItemCustomMoves sParty_Timothy2[] = {
    ...
    .lvl = 33,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_ARMTHRUST, MOVE_KNOCKOFF, MOVE_SANDATTACK, MOVE_DIG}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Timothy4[] = {
    ...
    .lvl = 39,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_ARMTHRUST, MOVE_BELLYDRUM, MOVE_SANDATTACK, MOVE_DIG}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vicky[] = {
    ...
    .lvl = 18,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_HIGHJUMPKICK, MOVE_MEDITATE, MOVE_CONFUSION, MOVE_DETECT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .lvl = 14,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_ROCKTHROW, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 15,
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 17,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_HEADBUTT, MOVE_SANDATTACK, MOVE_GROWL, MOVE_THUNDERBOLT}
    },
    {
    .iv = 150,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    ...
    .lvl = 43,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_ATTRACT, MOVE_ICEBEAM, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_DUSCLOPS,
    .moves = {MOVE_SKILLSWAP, MOVE_PROTECT, MOVE_WILLOWISP, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .moves = {MOVE_SKILLSWAP, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_CALMMIND}
    },
    {
    .iv = 100,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAINDANCE, MOVE_WATERSPOUT, MOVE_DOUBLEEDGE, MOVE_BLIZZARD}
    },
    {
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_HYDROPUMP, MOVE_SLUDGEBOMB, MOVE_ICEBEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGADRAIN, MOVE_SURF, MOVE_LEECHSEED, MOVE_DOUBLETEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_SURF, MOVE_AMNESIA, MOVE_HYPERBEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGONDANCE, MOVE_EARTHQUAKE, MOVE_HYPERBEAM, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_RECOVER, MOVE_SURF, MOVE_ICEBEAM, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Aaron[] = {
    ...
    .lvl = 34,
    .species = SPECIES_BAGON,
    .moves = {MOVE_DRAGONBREATH, MOVE_HEADBUTT, MOVE_FOCUSENERGY, MOVE_EMBER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_POISONGAS, MOVE_TACKLE, MOVE_SMOG, MOVE_SELFDESTRUCT}
    },
    {
    .iv = 0,
    .lvl = 17,
    ...
    .lvl = 17,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_POISONGAS, MOVE_TACKLE, MOVE_SLUDGE, MOVE_SELFDESTRUCT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao2[] = {
    ...
    .lvl = 24,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_POISONGAS, MOVE_TACKLE, MOVE_SLUDGE, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 24,
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .lvl = 19,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_EMBER, MOVE_TACKLE, MOVE_MAGNITUDE, MOVE_SUNNYDAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Angelica[] = {
    ...
    .moves = {MOVE_RAINDANCE, MOVE_WEATHERBALL, MOVE_THUNDER, MOVE_WATERPULSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline3[] = {
    ...
    .lvl = 32,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_EMBER, MOVE_TAKEDOWN, MOVE_MAGNITUDE, MOVE_SUNNYDAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline4[] = {
    ...
    .lvl = 34,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_LEECHSEED, MOVE_MEGADRAIN, MOVE_GRASSWHISTLE, MOVE_SUNNYDAY}
    },
    {
    .iv = 30,
    .lvl = 34,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_FLAMETHROWER, MOVE_TAKEDOWN, MOVE_MAGNITUDE, MOVE_SUNNYDAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline5[] = {
    ...
    .lvl = 37,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_LEECHSEED, MOVE_GIGADRAIN, MOVE_SOLARBEAM, MOVE_SUNNYDAY}
    },
    {
    .iv = 40,
    .lvl = 37,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_FLAMETHROWER, MOVE_TAKEDOWN, MOVE_EARTHQUAKE, MOVE_SUNNYDAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .lvl = 22,
    .species = SPECIES_SANDSHREW,
    .moves = {MOVE_SANDATTACK, MOVE_POISONSTING, MOVE_SLASH, MOVE_DIG}
    },
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_MARILL,
    .moves = {MOVE_ROLLOUT, MOVE_BUBBLEBEAM, MOVE_TAILWHIP, MOVE_DEFENSECURL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Cedric[] = {
    ...
    .lvl = 32,
    .species = SPECIES_WOBBUFFET,
    .moves = {MOVE_DESTINYBOND, MOVE_SAFEGUARD, MOVE_COUNTER, MOVE_MIRRORCOAT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GinaAndMia2[] = {
    ...
    .lvl = 10,
    .species = SPECIES_DUSKULL,
    .moves = {MOVE_NIGHTSHADE, MOVE_DISABLE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 10,
    .species = SPECIES_SHROOMISH,
    .moves = {MOVE_ABSORB, MOVE_LEECHSEED, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv5[] = {
    ...
    .lvl = 33,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_SPARK, MOVE_CHARGE, MOVE_FAKETEARS, MOVE_HELPINGHAND}
    },
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_MINUN,
    .moves = {MOVE_SPARK, MOVE_CHARGE, MOVE_CHARM, MOVE_HELPINGHAND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv6[] = {
    ...
    .lvl = 36,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_THUNDER, MOVE_CHARGE, MOVE_FAKETEARS, MOVE_HELPINGHAND}
    },
    {
    .iv = 40,
    .lvl = 36,
    .species = SPECIES_MINUN,
    .moves = {MOVE_THUNDER, MOVE_CHARGE, MOVE_CHARM, MOVE_HELPINGHAND}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Annika[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FLAIL, MOVE_WATERPULSE, MOVE_RETURN, MOVE_ATTRACT}
    },
    {
    .iv = 100,
    .lvl = 39,
...
static const struct TrainerMonNoItemCustomMoves sParty_Jonas[] = {
    ...
    .lvl = 31,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TOXIC, MOVE_THUNDER, MOVE_SELFDESTRUCT, MOVE_SLUDGEBOMB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kayley[] = {
    ...
    .lvl = 31,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_SUNNYDAY, MOVE_WEATHERBALL, MOVE_FLAMETHROWER, MOVE_SOLARBEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Marley[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_ROAR, MOVE_THUNDERWAVE, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 44,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_AERIALACE, MOVE_SAFEGUARD, MOVE_DRAGONBREATH, MOVE_DRAGONDANCE}
    },
    {
    .iv = 150,
    .lvl = 43,
    .species = SPECIES_DELCATTY,
    .moves = {MOVE_SING, MOVE_ASSIST, MOVE_CHARM, MOVE_FEINTATTACK}
    },
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_MAGICALLEAF, MOVE_LEECHSEED, MOVE_GIGADRAIN, MOVE_TOXIC}
    },
    {
    .iv = 150,
    .lvl = 41,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_SUPERSONIC, MOVE_THUNDERBOLT, MOVE_TRIATTACK, MOVE_SCREECH}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_DOUBLETEAM, MOVE_CALMMIND, MOVE_PSYCHIC, MOVE_FUTURESIGHT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Mitchell[] = {
    ...
    .lvl = 43,
    .species = SPECIES_LUNATONE,
    .moves = {MOVE_EXPLOSION, MOVE_REFLECT, MOVE_LIGHTSCREEN, MOVE_PSYCHIC}
    },
    {
    .iv = 0,
    .lvl = 43,
    .species = SPECIES_SOLROCK,
    .moves = {MOVE_EXPLOSION, MOVE_REFLECT, MOVE_LIGHTSCREEN, MOVE_SHADOWBALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Athena[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_THUNDERWAVE, MOVE_QUICKATTACK, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 32,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lucas2[] = {
    ...
    .lvl = 9,
    .species = SPECIES_WAILMER,
    .moves = {MOVE_SPLASH, MOVE_WATERGUN, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Mike1[] = {
    ...
    .lvl = 10,
    .species = SPECIES_POOCHYENA,
    .moves = {MOVE_BITE, MOVE_SCARYFACE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .lvl = 23,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_FLAMETHROWER, MOVE_FURYSWIPES, MOVE_FEINTATTACK, MOVE_BIND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .lvl = 17,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_BIDE, MOVE_DETECT, MOVE_CONFUSION, MOVE_THUNDERPUNCH}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_THUNDERPUNCH, MOVE_DETECT, MOVE_CONFUSION, MOVE_MEDITATE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .lvl = 23,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_BIDE, MOVE_DETECT, MOVE_CONFUSION, MOVE_FIREPUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_SELFDESTRUCT, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 25,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_POISONGAS, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Keigo[] = {
    ...
    .lvl = 28,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_POISONGAS, MOVE_SELFDESTRUCT, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SANDATTACK, MOVE_DOUBLETEAM, MOVE_FURYCUTTER, MOVE_SWORDSDANCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Riley[] = {
    ...
    .lvl = 28,
    .species = SPECIES_NINCADA,
    .moves = {MOVE_LEECHLIFE, MOVE_FURYSWIPES, MOVE_MINDREADER, MOVE_DIG}
    },
    {
    .iv = 0,
    .lvl = 28,
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 32,
    .species = SPECIES_SWABLU,
    .moves = {MOVE_SING, MOVE_FURYATTACK, MOVE_SAFEGUARD, MOVE_AERIALACE}
    },
    {
    .iv = 0,
    .lvl = 35,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_FLAMETHROWER, MOVE_TAKEDOWN, MOVE_REST, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 18,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_GROWTH, MOVE_STUNSPORE, MOVE_MEGADRAIN, MOVE_LEECHSEED}
    },
    {
    .iv = 0,
    .lvl = 20,
    .species = SPECIES_GRAVELER,
    .moves = {MOVE_DEFENSECURL, MOVE_ROLLOUT, MOVE_MUDSPORT, MOVE_ROCKTHROW}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MelAndPaul[] = {
    ...
    .lvl = 27,
    .species = SPECIES_BEAUTIFLY,
    .moves = {MOVE_GUST, MOVE_MEGADRAIN, MOVE_ATTRACT, MOVE_STUNSPORE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .lvl = 39,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_PSYCHIC, MOVE_FIREPUNCH, MOVE_PSYCHUP, MOVE_PROTECT}
    },
    {
    .iv = 200,
    .lvl = 39,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FOCUSPUNCH, MOVE_ROCKTOMB, MOVE_REST, MOVE_BELLYDRUM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .lvl = 30,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_THUNDER, MOVE_QUICKATTACK, MOVE_THUNDERWAVE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .species = SPECIES_KABUTO,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDSDANCE, MOVE_ICEBEAM, MOVE_SURF, MOVE_ROCKSLIDE}
    },
    {
    .iv = 255,
    .lvl = 35,
    .species = SPECIES_ONIX,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRONTAIL, MOVE_EXPLOSION, MOVE_ROAR, MOVE_ROCKSLIDE}
    },
    {
    .iv = 255,
    .lvl = 37,
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLETEAM, MOVE_EXPLOSION, MOVE_PROTECT, MOVE_ROCKSLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .species = SPECIES_OMANYTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_ICEBEAM, MOVE_ROCKSLIDE, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 37,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCKSLIDE, MOVE_HYPERBEAM, MOVE_SUPERSONIC, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 47,
    .species = SPECIES_GOLEM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUSPUNCH, MOVE_ROLLOUT, MOVE_EARTHQUAKE, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_KARATECHOP, MOVE_ROCKSLIDE, MOVE_FOCUSPUNCH, MOVE_BULKUP}
    },
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_LIGHTSCREEN, MOVE_REFLECT, MOVE_FOCUSPUNCH}
    },
    {
    .iv = 255,
    .lvl = 35,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PURSUIT, MOVE_COUNTER, MOVE_PROTECT, MOVE_TRIPLEKICK}
    },
    {
    .iv = 255,
    .lvl = 37,
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FAKEOUT, MOVE_FOCUSPUNCH, MOVE_BELLYDRUM, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SKYUPPERCUT, MOVE_PROTECT, MOVE_FIREPUNCH, MOVE_ICEPUNCH}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUSPUNCH, MOVE_LIGHTSCREEN, MOVE_REFLECT, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGAKICK, MOVE_FOCUSPUNCH, MOVE_EARTHQUAKE, MOVE_BULKUP}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CROSSCHOP, MOVE_ROCKSLIDE, MOVE_FOCUSPUNCH, MOVE_BULKUP}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_PROTECT, MOVE_THUNDERWAVE, MOVE_LIGHTSCREEN}
    },
    {
    .iv = 255,
    .lvl = 36,
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROLLOUT, MOVE_THUNDER, MOVE_EXPLOSION, MOVE_RAINDANCE}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUPERSONIC, MOVE_PROTECT, MOVE_THUNDER, MOVE_RAINDANCE}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BITE, MOVE_THUNDERWAVE, MOVE_THUNDER, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = {
    ...
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_SLAM, MOVE_RAINDANCE, MOVE_SHOCKWAVE}
    },
    {
    .iv = 255,
    .lvl = 41,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_SLAM, MOVE_RAINDANCE, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 46,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWIFT, MOVE_FOCUSPUNCH, MOVE_THUNDERPUNCH, MOVE_LIGHTSCREEN}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_ATTRACT, MOVE_LIGHTSCREEN, MOVE_ROCKSLIDE}
    },
    {
    .iv = 255,
    .lvl = 36,
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNYDAY, MOVE_EARTHQUAKE, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_SUNNYDAY, MOVE_EXPLOSION, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HELPINGHAND, MOVE_FLAMETHROWER, MOVE_ROAR, MOVE_SUNNYDAY}
    },
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROAR, MOVE_SOLARBEAM, MOVE_TAUNT, MOVE_SUNNYDAY}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_GROWLITHE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HELPINGHAND, MOVE_FLAMETHROWER, MOVE_SUNNYDAY, MOVE_ROAR}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIGHTSCREEN, MOVE_SING, MOVE_SKILLSWAP, MOVE_FOCUSPUNCH}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BLIZZARD, MOVE_SHADOWBALL, MOVE_DOUBLEEDGE, MOVE_FIREBLAST}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_SPINDA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TEETERDANCE, MOVE_SKILLSWAP, MOVE_FACADE, MOVE_HYPNOSIS}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYPERBEAM, MOVE_FLAMETHROWER, MOVE_THUNDERBOLT, MOVE_SHADOWBALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKEOUT, MOVE_DIZZYPUNCH, MOVE_ENDURE, MOVE_REVERSAL}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Norman5[] = {
    ...
    .species = SPECIES_BLISSEY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_SING, MOVE_SKILLSWAP, MOVE_FOCUSPUNCH}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAKEDOWN, MOVE_PROTECT, MOVE_FIREBLAST, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERWAVE, MOVE_THUNDERBOLT, MOVE_PROTECT, MOVE_ICEBEAM}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNYDAY, MOVE_AERIALACE, MOVE_SOLARBEAM, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_SUPERSONIC, MOVE_PROTECT, MOVE_AERIALACE}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WHIRLWIND, MOVE_SPIKES, MOVE_STEELWING, MOVE_AERIALACE}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_AERIALACE, MOVE_REST, MOVE_DRAGONDANCE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona3[] = {
    ...
    .species = SPECIES_HOOTHOOT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_REFLECT, MOVE_DREAMEATER}
    },
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Winona5[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYPERBEAM, MOVE_THUNDERBOLT, MOVE_EARTHQUAKE, MOVE_ICEBEAM}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_SKYATTACK, MOVE_REST, MOVE_DRAGONDANCE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_YAWN, MOVE_PSYCHIC, MOVE_CALMMIND, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .species = SPECIES_XATU,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_REST, MOVE_CONFUSERAY, MOVE_CALMMIND}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_REST, MOVE_CALMMIND}
    },
    {
    .iv = 255,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_DREAMEATER, MOVE_HEADBUTT, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_EXPLOSION, MOVE_PSYCHIC, MOVE_LIGHTSCREEN}
    },
    {
    .iv = 255,
    .lvl = 54,
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_RAINDANCE, MOVE_PROTECT, MOVE_HYDROPUMP}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAINDANCE, MOVE_WATERPULSE, MOVE_DOUBLETEAM, MOVE_FISSURE}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATERPULSE, MOVE_BODYSLAM, MOVE_PROTECT, MOVE_ICEBEAM}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_CRABHAMMER, MOVE_TAUNT, MOVE_DOUBLETEAM}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Juan3[] = {
    ...
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_GUILLOTINE, MOVE_TAUNT, MOVE_DOUBLETEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Juan4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDROPUMP, MOVE_PERISHSONG, MOVE_ICEBEAM, MOVE_CONFUSERAY}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Juan5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_RAINDANCE, MOVE_HYDROPUMP, MOVE_PERISHSONG}
    },
    {
    .iv = 255,
    .lvl = 63,
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATERPULSE, MOVE_BODYSLAM, MOVE_PROTECT, MOVE_SHEERCOLD}
    },
    {
    .iv = 255,
    .lvl = 63,
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_ILLUMISE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCKWAVE, MOVE_QUICKATTACK, MOVE_CHARM, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_VOLBEAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCKWAVE, MOVE_QUICKATTACK, MOVE_CONFUSERAY, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_AERIALACE, MOVE_SPIKES, MOVE_STEELWING}
    },
    {
    .iv = 255,
    .lvl = 75,
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REFLECT, MOVE_LIGHTSCREEN, MOVE_ANCIENTPOWER, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 76,
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_EARTHQUAKE, MOVE_SOLARBEAM, MOVE_DRAGONCLAW}
    },
    {
    .iv = 255,
    .lvl = 76,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGADRAIN, MOVE_ANCIENTPOWER, MOVE_INGRAIN, MOVE_CONFUSERAY}
    },
    {
    .iv = 255,
    .lvl = 76,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATERPULSE, MOVE_ANCIENTPOWER, MOVE_AERIALACE, MOVE_SLASH}
    },
    {
    .iv = 255,
    .lvl = 78,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_METEORMASH, MOVE_SHADOWBALL}
    }
};
