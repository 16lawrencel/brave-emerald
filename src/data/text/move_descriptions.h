...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_KARATECHOP - 1] = sKarateChopDescription,
    [MOVE_DOUBLESLAP - 1] = sDoubleSlapDescription,
    [MOVE_COMETPUNCH - 1] = sCometPunchDescription,
    [MOVE_MEGAPUNCH - 1] = sMegaPunchDescription,
    [MOVE_PAYDAY - 1] = sPayDayDescription,
    [MOVE_FIREPUNCH - 1] = sFirePunchDescription,
    [MOVE_ICEPUNCH - 1] = sIcePunchDescription,
    [MOVE_THUNDERPUNCH - 1] = sThunderPunchDescription,
    [MOVE_SCRATCH - 1] = sScratchDescription,
    [MOVE_VICEGRIP - 1] = sViceGripDescription,
    [MOVE_GUILLOTINE - 1] = sGuillotineDescription,
    [MOVE_RAZORWIND - 1] = sRazorWindDescription,
    [MOVE_SWORDSDANCE - 1] = sSwordsDanceDescription,
    [MOVE_CUT - 1] = sCutDescription,
    [MOVE_GUST - 1] = sGustDescription,
    [MOVE_WINGATTACK - 1] = sWingAttackDescription,
    [MOVE_WHIRLWIND - 1] = sWhirlwindDescription,
    [MOVE_FLY - 1] = sFlyDescription,
    [MOVE_BIND - 1] = sBindDescription,
    [MOVE_SLAM - 1] = sSlamDescription,
    [MOVE_VINEWHIP - 1] = sVineWhipDescription,
    [MOVE_STOMP - 1] = sStompDescription,
    [MOVE_DOUBLEKICK - 1] = sDoubleKickDescription,
    [MOVE_MEGAKICK - 1] = sMegaKickDescription,
    [MOVE_JUMPKICK - 1] = sJumpKickDescription,
    [MOVE_ROLLINGKICK - 1] = sRollingKickDescription,
    [MOVE_SANDATTACK - 1] = sSandAttackDescription,
    [MOVE_HEADBUTT - 1] = sHeadbuttDescription,
    [MOVE_HORNATTACK - 1] = sHornAttackDescription,
    [MOVE_FURYATTACK - 1] = sFuryAttackDescription,
    [MOVE_HORNDRILL - 1] = sHornDrillDescription,
    [MOVE_TACKLE - 1] = sTackleDescription,
    [MOVE_BODYSLAM - 1] = sBodySlamDescription,
    [MOVE_WRAP - 1] = sWrapDescription,
    [MOVE_TAKEDOWN - 1] = sTakeDownDescription,
    [MOVE_THRASH - 1] = sThrashDescription,
    [MOVE_DOUBLEEDGE - 1] = sDoubleEdgeDescription,
    [MOVE_TAILWHIP - 1] = sTailWhipDescription,
    [MOVE_POISONSTING - 1] = sPoisonStingDescription,
    [MOVE_TWINEEDLE - 1] = sTwineedleDescription,
    [MOVE_PINMISSILE - 1] = sPinMissileDescription,
    ...
    [MOVE_SONICBOOM - 1] = sSonicBoomDescription,
    ...
    [MOVE_WATERGUN - 1] = sWaterGunDescription,
    [MOVE_HYDROPUMP - 1] = sHydroPumpDescription,
    [MOVE_SURF - 1] = sSurfDescription,
    [MOVE_ICEBEAM - 1] = sIceBeamDescription,
    [MOVE_BLIZZARD - 1] = sBlizzardDescription,
    [MOVE_PSYBEAM - 1] = sPsybeamDescription,
    [MOVE_BUBBLEBEAM - 1] = sBubbleBeamDescription,
    [MOVE_AURORABEAM - 1] = sAuroraBeamDescription,
    [MOVE_HYPERBEAM - 1] = sHyperBeamDescription,
    [MOVE_PECK - 1] = sPeckDescription,
    [MOVE_DRILLPECK - 1] = sDrillPeckDescription,
    [MOVE_SUBMISSION - 1] = sSubmissionDescription,
    [MOVE_LOWKICK - 1] = sLowKickDescription,
    [MOVE_COUNTER - 1] = sCounterDescription,
    [MOVE_SEISMICTOSS - 1] = sSeismicTossDescription,
    [MOVE_STRENGTH - 1] = sStrengthDescription,
    [MOVE_ABSORB - 1] = sAbsorbDescription,
    [MOVE_MEGADRAIN - 1] = sMegaDrainDescription,
    [MOVE_LEECHSEED - 1] = sLeechSeedDescription,
    [MOVE_GROWTH - 1] = sGrowthDescription,
    [MOVE_RAZORLEAF - 1] = sRazorLeafDescription,
    [MOVE_SOLARBEAM - 1] = sSolarBeamDescription,
    [MOVE_POISONPOWDER - 1] = sPoisonPowderDescription,
    [MOVE_STUNSPORE - 1] = sStunSporeDescription,
    [MOVE_SLEEPPOWDER - 1] = sSleepPowderDescription,
    [MOVE_PETALDANCE - 1] = sPetalDanceDescription,
    [MOVE_STRINGSHOT - 1] = sStringShotDescription,
    [MOVE_DRAGONRAGE - 1] = sDragonRageDescription,
    [MOVE_FIRESPIN - 1] = sFireSpinDescription,
    [MOVE_THUNDERSHOCK - 1] = sThunderShockDescription,
    [MOVE_THUNDERBOLT - 1] = sThunderboltDescription,
    [MOVE_THUNDERWAVE - 1] = sThunderWaveDescription,
    [MOVE_THUNDER - 1] = sThunderDescription,
    [MOVE_ROCKTHROW - 1] = sRockThrowDescription,
    ...
    [MOVE_CONFUSERAY - 1] = sConfuseRayDescription,
    [MOVE_WITHDRAW - 1] = sWithdrawDescription,
    [MOVE_DEFENSECURL - 1] = sDefenseCurlDescription,
    [MOVE_BARRIER - 1] = sBarrierDescription,
    [MOVE_LIGHTSCREEN - 1] = sLightScreenDescription,
    [MOVE_HAZE - 1] = sHazeDescription,
    [MOVE_REFLECT - 1] = sReflectDescription,
    [MOVE_FOCUSENERGY - 1] = sFocusEnergyDescription,
    [MOVE_BIDE - 1] = sBideDescription,
    [MOVE_METRONOME - 1] = sMetronomeDescription,
    [MOVE_MIRRORMOVE - 1] = sMirrorMoveDescription,
    [MOVE_SELFDESTRUCT - 1] = sSelfDestructDescription,
    [MOVE_EGGBOMB - 1] = sEggBombDescription,
    [MOVE_LICK - 1] = sLickDescription,
    [MOVE_SMOG - 1] = sSmogDescription,
    [MOVE_SLUDGE - 1] = sSludgeDescription,
    [MOVE_BONECLUB - 1] = sBoneClubDescription,
    [MOVE_FIREBLAST - 1] = sFireBlastDescription,
    [MOVE_WATERFALL - 1] = sWaterfallDescription,
    [MOVE_CLAMP - 1] = sClampDescription,
    [MOVE_SWIFT - 1] = sSwiftDescription,
    [MOVE_SKULLBASH - 1] = sSkullBashDescription,
    [MOVE_SPIKECANNON - 1] = sSpikeCannonDescription,
    [MOVE_CONSTRICT - 1] = sConstrictDescription,
    [MOVE_AMNESIA - 1] = sAmnesiaDescription,
    [MOVE_KINESIS - 1] = sKinesisDescription,
    [MOVE_SOFTBOILED - 1] = sSoftBoiledDescription,
    [MOVE_HIGHJUMPKICK - 1] = sHiJumpKickDescription,
    [MOVE_GLARE - 1] = sGlareDescription,
    [MOVE_DREAMEATER - 1] = sDreamEaterDescription,
    [MOVE_POISONGAS - 1] = sPoisonGasDescription,
    [MOVE_BARRAGE - 1] = sBarrageDescription,
    [MOVE_LEECHLIFE - 1] = sLeechLifeDescription,
    [MOVE_LOVELYKISS - 1] = sLovelyKissDescription,
    [MOVE_SKYATTACK - 1] = sSkyAttackDescription,
    [MOVE_TRANSFORM - 1] = sTransformDescription,
    [MOVE_BUBBLE - 1] = sBubbleDescription,
    [MOVE_DIZZYPUNCH - 1] = sDizzyPunchDescription,
    ...
    [MOVE_ACIDARMOR - 1] = sAcidArmorDescription,
    [MOVE_CRABHAMMER - 1] = sCrabhammerDescription,
    [MOVE_EXPLOSION - 1] = sExplosionDescription,
    [MOVE_FURYSWIPES - 1] = sFurySwipesDescription,
    [MOVE_BONEMERANG - 1] = sBonemerangDescription,
    [MOVE_REST - 1] = sRestDescription,
    [MOVE_ROCKSLIDE - 1] = sRockSlideDescription,
    [MOVE_HYPERFANG - 1] = sHyperFangDescription,
    [MOVE_SHARPEN - 1] = sSharpenDescription,
    [MOVE_CONVERSION - 1] = sConversionDescription,
    [MOVE_TRIATTACK - 1] = sTriAttackDescription,
    [MOVE_SUPERFANG - 1] = sSuperFangDescription,
    ...
    [MOVE_TRIPLEKICK - 1] = sTripleKickDescription,
    [MOVE_THIEF - 1] = sThiefDescription,
    [MOVE_SPIDERWEB - 1] = sSpiderWebDescription,
    [MOVE_MINDREADER - 1] = sMindReaderDescription,
    [MOVE_NIGHTMARE - 1] = sNightmareDescription,
    [MOVE_FLAMEWHEEL - 1] = sFlameWheelDescription,
    [MOVE_SNORE - 1] = sSnoreDescription,
    [MOVE_CURSE - 1] = sCurseDescription,
    [MOVE_FLAIL - 1] = sFlailDescription,
    [MOVE_CONVERSION2 - 1] = sConversion2Description,
    [MOVE_AEROBLAST - 1] = sAeroblastDescription,
    [MOVE_COTTONSPORE - 1] = sCottonSporeDescription,
    [MOVE_REVERSAL - 1] = sReversalDescription,
    [MOVE_SPITE - 1] = sSpiteDescription,
    [MOVE_POWDERSNOW - 1] = sPowderSnowDescription,
    [MOVE_PROTECT - 1] = sProtectDescription,
    [MOVE_MACHPUNCH - 1] = sMachPunchDescription,
    [MOVE_SCARYFACE - 1] = sScaryFaceDescription,
    [MOVE_FEINTATTACK - 1] = sFaintAttackDescription,
    [MOVE_SWEETKISS - 1] = sSweetKissDescription,
    [MOVE_BELLYDRUM - 1] = sBellyDrumDescription,
    [MOVE_SLUDGEBOMB - 1] = sSludgeBombDescription,
    [MOVE_MUDSLAP - 1] = sMudSlapDescription,
    [MOVE_OCTAZOOKA - 1] = sOctazookaDescription,
    [MOVE_SPIKES - 1] = sSpikesDescription,
    [MOVE_ZAPCANNON - 1] = sZapCannonDescription,
    [MOVE_FORESIGHT - 1] = sForesightDescription,
    [MOVE_DESTINYBOND - 1] = sDestinyBondDescription,
    [MOVE_PERISHSONG - 1] = sPerishSongDescription,
    [MOVE_ICYWIND - 1] = sIcyWindDescription,
    [MOVE_DETECT - 1] = sDetectDescription,
    [MOVE_BONERUSH - 1] = sBoneRushDescription,
    [MOVE_LOCKON - 1] = sLockOnDescription,
    [MOVE_OUTRAGE - 1] = sOutrageDescription,
    [MOVE_SANDSTORM - 1] = sSandstormDescription,
    [MOVE_GIGADRAIN - 1] = sGigaDrainDescription,
    [MOVE_ENDURE - 1] = sEndureDescription,
    [MOVE_CHARM - 1] = sCharmDescription,
    [MOVE_ROLLOUT - 1] = sRolloutDescription,
    [MOVE_FALSESWIPE - 1] = sFalseSwipeDescription,
    [MOVE_SWAGGER - 1] = sSwaggerDescription,
    [MOVE_MILKDRINK - 1] = sMilkDrinkDescription,
    [MOVE_SPARK - 1] = sSparkDescription,
    [MOVE_FURYCUTTER - 1] = sFuryCutterDescription,
    [MOVE_STEELWING - 1] = sSteelWingDescription,
    [MOVE_MEANLOOK - 1] = sMeanLookDescription,
    [MOVE_ATTRACT - 1] = sAttractDescription,
    [MOVE_SLEEPTALK - 1] = sSleepTalkDescription,
    [MOVE_HEALBELL - 1] = sHealBellDescription,
    ...
    [MOVE_PAINSPLIT - 1] = sPainSplitDescription,
    [MOVE_SACREDFIRE - 1] = sSacredFireDescription,
    [MOVE_MAGNITUDE - 1] = sMagnitudeDescription,
    [MOVE_DYNAMICPUNCH - 1] = sDynamicPunchDescription,
    [MOVE_MEGAHORN - 1] = sMegahornDescription,
    [MOVE_DRAGONBREATH - 1] = sDragonBreathDescription,
    [MOVE_BATONPASS - 1] = sBatonPassDescription,
    [MOVE_ENCORE - 1] = sEncoreDescription,
    [MOVE_PURSUIT - 1] = sPursuitDescription,
    [MOVE_RAPIDSPIN - 1] = sRapidSpinDescription,
    [MOVE_SWEETSCENT - 1] = sSweetScentDescription,
    [MOVE_IRONTAIL - 1] = sIronTailDescription,
    [MOVE_METALCLAW - 1] = sMetalClawDescription,
    [MOVE_VITALTHROW - 1] = sVitalThrowDescription,
    [MOVE_MORNINGSUN - 1] = sMorningSunDescription,
    [MOVE_SYNTHESIS - 1] = sSynthesisDescription,
    [MOVE_MOONLIGHT - 1] = sMoonlightDescription,
    [MOVE_HIDDENPOWER - 1] = sHiddenPowerDescription,
    [MOVE_CROSSCHOP - 1] = sCrossChopDescription,
    [MOVE_TWISTER - 1] = sTwisterDescription,
    [MOVE_RAINDANCE - 1] = sRainDanceDescription,
    [MOVE_SUNNYDAY - 1] = sSunnyDayDescription,
    [MOVE_CRUNCH - 1] = sCrunchDescription,
    [MOVE_MIRRORCOAT - 1] = sMirrorCoatDescription,
    [MOVE_PSYCHUP - 1] = sPsychUpDescription,
    [MOVE_EXTREMESPEED - 1] = sExtremeSpeedDescription,
    [MOVE_ANCIENTPOWER - 1] = sAncientPowerDescription,
    [MOVE_SHADOWBALL - 1] = sShadowBallDescription,
    [MOVE_FUTURESIGHT - 1] = sFutureSightDescription,
    [MOVE_ROCKSMASH - 1] = sRockSmashDescription,
    [MOVE_WHIRLPOOL - 1] = sWhirlpoolDescription,
    [MOVE_BEATUP - 1] = sBeatUpDescription,
    [MOVE_FAKEOUT - 1] = sFakeOutDescription,
    [MOVE_UPROAR - 1] = sUproarDescription,
    [MOVE_STOCKPILE - 1] = sStockpileDescription,
    [MOVE_SPITUP - 1] = sSpitUpDescription,
    [MOVE_SWALLOW - 1] = sSwallowDescription,
    [MOVE_HEATWAVE - 1] = sHeatWaveDescription,
    [MOVE_HAIL - 1] = sHailDescription,
    [MOVE_TORMENT - 1] = sTormentDescription,
    [MOVE_FLATTER - 1] = sFlatterDescription,
    [MOVE_WILLOWISP - 1] = sWillOWispDescription,
    [MOVE_MEMENTO - 1] = sMementoDescription,
    [MOVE_FACADE - 1] = sFacadeDescription,
    [MOVE_FOCUSPUNCH - 1] = sFocusPunchDescription,
    [MOVE_SMELLINGSALTS - 1] = sSmellingSaltDescription,
    [MOVE_FOLLOWME - 1] = sFollowMeDescription,
    [MOVE_NATUREPOWER - 1] = sNaturePowerDescription,
    [MOVE_CHARGE - 1] = sChargeDescription,
    [MOVE_TAUNT - 1] = sTauntDescription,
    [MOVE_HELPINGHAND - 1] = sHelpingHandDescription,
    [MOVE_TRICK - 1] = sTrickDescription,
    [MOVE_ROLEPLAY - 1] = sRolePlayDescription,
    ...
    [MOVE_SECRETPOWER - 1] = sSecretPowerDescription,
    [MOVE_DIVE - 1] = sDiveDescription,
    [MOVE_ARMTHRUST - 1] = sArmThrustDescription,
    [MOVE_CAMOUFLAGE - 1] = sCamouflageDescription,
    [MOVE_TAILGLOW - 1] = sTailGlowDescription,
    [MOVE_LUSTERPURGE - 1] = sLusterPurgeDescription,
    [MOVE_MISTBALL - 1] = sMistBallDescription,
    [MOVE_FEATHERDANCE - 1] = sFeatherDanceDescription,
    [MOVE_TEETERDANCE - 1] = sTeeterDanceDescription,
    [MOVE_BLAZEKICK - 1] = sBlazeKickDescription,
    [MOVE_MUDSPORT - 1] = sMudSportDescription,
    [MOVE_ICEBALL - 1] = sIceBallDescription,
    [MOVE_NEEDLEARM - 1] = sNeedleArmDescription,
    [MOVE_SLACKOFF - 1] = sSlackOffDescription,
    [MOVE_HYPERVOICE - 1] = sHyperVoiceDescription,
    [MOVE_POISONFANG - 1] = sPoisonFangDescription,
    [MOVE_CRUSHCLAW - 1] = sCrushClawDescription,
    [MOVE_BLASTBURN - 1] = sBlastBurnDescription,
    [MOVE_HYDROCANNON - 1] = sHydroCannonDescription,
    [MOVE_METEORMASH - 1] = sMeteorMashDescription,
    [MOVE_ASTONISH - 1] = sAstonishDescription,
    [MOVE_WEATHERBALL - 1] = sWeatherBallDescription,
    [MOVE_AROMATHERAPY - 1] = sAromatherapyDescription,
    [MOVE_FAKETEARS - 1] = sFakeTearsDescription,
    [MOVE_AIRCUTTER - 1] = sAirCutterDescription,
    [MOVE_OVERHEAT - 1] = sOverheatDescription,
    [MOVE_ODORSLEUTH - 1] = sOdorSleuthDescription,
    [MOVE_ROCKTOMB - 1] = sRockTombDescription,
    [MOVE_SILVERWIND - 1] = sSilverWindDescription,
    [MOVE_METALSOUND - 1] = sMetalSoundDescription,
    [MOVE_GRASSWHISTLE - 1] = sGrassWhistleDescription,
    [MOVE_TICKLE - 1] = sTickleDescription,
    [MOVE_COSMICPOWER - 1] = sCosmicPowerDescription,
    [MOVE_WATERSPOUT - 1] = sWaterSpoutDescription,
    [MOVE_SIGNALBEAM - 1] = sSignalBeamDescription,
    [MOVE_SHADOWPUNCH - 1] = sShadowPunchDescription,
    [MOVE_EXTRASENSORY - 1] = sExtrasensoryDescription,
    [MOVE_SKYUPPERCUT - 1] = sSkyUppercutDescription,
    [MOVE_SANDTOMB - 1] = sSandTombDescription,
    [MOVE_SHEERCOLD - 1] = sSheerColdDescription,
    [MOVE_MUDDYWATER - 1] = sMuddyWaterDescription,
    [MOVE_BULLETSEED - 1] = sBulletSeedDescription,
    [MOVE_AERIALACE - 1] = sAerialAceDescription,
    [MOVE_ICICLESPEAR - 1] = sIcicleSpearDescription,
    [MOVE_IRONDEFENSE - 1] = sIronDefenseDescription,
    [MOVE_BLOCK - 1] = sBlockDescription,
    [MOVE_HOWL - 1] = sHowlDescription,
    [MOVE_DRAGONCLAW - 1] = sDragonClawDescription,
    [MOVE_FRENZYPLANT - 1] = sFrenzyPlantDescription,
    [MOVE_BULKUP - 1] = sBulkUpDescription,
    [MOVE_BOUNCE - 1] = sBounceDescription,
    [MOVE_MUDSHOT - 1] = sMudShotDescription,
    [MOVE_POISONTAIL - 1] = sPoisonTailDescription,
    [MOVE_COVET - 1] = sCovetDescription,
    [MOVE_VOLTTACKLE - 1] = sVoltTackleDescription,
    [MOVE_MAGICALLEAF - 1] = sMagicalLeafDescription,
    [MOVE_WATERSPORT - 1] = sWaterSportDescription,
    [MOVE_CALMMIND - 1] = sCalmMindDescription,
    [MOVE_LEAFBLADE - 1] = sLeafBladeDescription,
    [MOVE_DRAGONDANCE - 1] = sDragonDanceDescription,
    [MOVE_ROCKBLAST - 1] = sRockBlastDescription,
    [MOVE_SHOCKWAVE - 1] = sShockWaveDescription,
    [MOVE_WATERPULSE - 1] = sWaterPulseDescription,
    [MOVE_DOOMDESIRE - 1] = sDoomDesireDescription,
    [MOVE_PSYCHOBOOST - 1] = sPsychoBoostDescription,
};
