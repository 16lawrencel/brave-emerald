...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [SLATEPORT_TENT_TRAINER_MALACHI] = {
        ...
        .speechBefore = {EC_WORD_BAD, EC_WORD_NEWS, EC_WORD_EXCL, EC_WORD_IT_S, EC_WORD_A, EC_MOVE(SANDTOMB)},
        .speechWin = {EC_WORD_YEEHAW_EXCL, -1, -1, EC_WORD_I_VE, EC_WORD_DONE, EC_WORD_IT},
        .speechLose = {EC_WORD_I_VE, EC_WORD_LOST, EC_WORD_IN, EC_WORD_THIS, EC_MOVE(SANDTOMB), EC_WORD_ELLIPSIS},
    ...
    [SLATEPORT_TENT_TRAINER_DAVON] = {
        ...
        .speechLose = {EC_WORD_DON_T, EC_WORD_GET, EC_MOVE2(BEATUP), EC_WORD_IN, EC_WORD_THAT, EC_MOVE(WHIRLPOOL)},
    ...
    [SLATEPORT_TENT_TRAINER_KENDALL] = {
        ...
        .speechBefore = {EC_WORD_A_LITTLE, EC_MOVE2(PETALDANCE), EC_WORD_TO, EC_WORD_PLEASE, EC_WORD_YOU, EC_WORD_EXCL},
    ...
    [SLATEPORT_TENT_TRAINER_IRVIN] = {
        ...
        .trainerName = _("IRVIN"),
        .speechBefore = {EC_WORD_HAVE, EC_WORD_A, EC_WORD_LOOK, EC_WORD_AT, EC_WORD_MY, EC_MOVE(CONFUSERAY)},
        .speechWin = {EC_WORD_YAHOO, EC_WORD_MY, EC_MOVE(CONFUSERAY), EC_WORD_IS, EC_WORD_THE, EC_WORD_BEST},
    ...
    [SLATEPORT_TENT_TRAINER_KURTIS] = {
        ...
        .speechBefore = {EC_WORD_SORRY, EC_WORD_YOU_RE, EC_WORD_GOING, EC_WORD_TO, EC_WORD_GET, EC_MOVE2(BEATUP)},
        .speechWin = {EC_WORD_I, EC_WORD_SAID, EC_WORD_WE, EC_WORD_WOULD, EC_MOVE2(POUND), EC_WORD_YOU},
        .speechLose = {EC_WORD_HOW, EC_WORD_DID, EC_WORD_I, EC_WORD_GET, EC_MOVE2(BEATUP), EC_WORD_QUES},
    ...
    [SLATEPORT_TENT_TRAINER_DONOVAN] = {
        ...
        .speechWin = {EC_WORD_YOU_RE, EC_WORD_GOING, EC_WORD_DOWN, EC_WORD_THE, EC_MOVE2(MEGADRAIN), EC_WORD_HAHAHA},
...
const struct FacilityMon gSlateportBattleTentMons[NUM_SLATEPORT_TENT_MONS] =
{
    [SLATEPORT_TENT_MON_ZIGZAGOON_1] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_CHARM, MOVE_ODORSLEUTH, MOVE_PINMISSILE},
    ...
    [SLATEPORT_TENT_MON_ZIGZAGOON_2] = {
        .species = SPECIES_ZIGZAGOON,
        .moves = {MOVE_DIG, MOVE_MUDSPORT, MOVE_TAILWHIP, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_BEAUTIFLY] = {
        ...
        .moves = {MOVE_STUNSPORE, MOVE_MEGADRAIN, MOVE_GUST, MOVE_HARDEN},
    ...
    [SLATEPORT_TENT_MON_DUSTOX] = {
        ...
        .moves = {MOVE_POISONSTING, MOVE_MOONLIGHT, MOVE_PROTECT, MOVE_GUST},
    ...
    [SLATEPORT_TENT_MON_WAILMER_2] = {
        .species = SPECIES_WAILMER,
        .moves = {MOVE_ROLLOUT, MOVE_GROWL, MOVE_WHIRLPOOL, MOVE_WATERPULSE},
    ...
    [SLATEPORT_TENT_MON_MARILL_1] = {
        ...
        .moves = {MOVE_ROLLOUT, MOVE_DEFENSECURL, MOVE_TAILWHIP, MOVE_BUBBLEBEAM},
    ...
    [SLATEPORT_TENT_MON_WINGULL_1] = {
        ...
        .moves = {MOVE_SUPERSONIC, MOVE_GROWL, MOVE_WINGATTACK, MOVE_STEELWING},
    ...
    [SLATEPORT_TENT_MON_PELIPPER_1] = {
        ...
        .moves = {MOVE_TWISTER, MOVE_WATERSPORT, MOVE_GROWL, MOVE_WINGATTACK},
    ...
    [SLATEPORT_TENT_MON_CACNEA_1] = {
        ...
        .moves = {MOVE_SANDSTORM, MOVE_LEER, MOVE_LEECHSEED, MOVE_PINMISSILE},
    ...
    [SLATEPORT_TENT_MON_LOMBRE_1] = {
        ...
        .moves = {MOVE_ASTONISH, MOVE_WATERGUN, MOVE_FAKEOUT, MOVE_ABSORB},
    ...
    [SLATEPORT_TENT_MON_LOTAD] = {
        ...
        .moves = {MOVE_SYNTHESIS, MOVE_NATUREPOWER, MOVE_RAINDANCE, MOVE_MEGADRAIN},
    ...
    [SLATEPORT_TENT_MON_SEEDOT] = {
        ...
        .moves = {MOVE_SUNNYDAY, MOVE_SYNTHESIS, MOVE_LEECHSEED, MOVE_BIDE},
    ...
    [SLATEPORT_TENT_MON_NUZLEAF] = {
        ...
        .moves = {MOVE_FAKEOUT, MOVE_NATUREPOWER, MOVE_HARDEN, MOVE_ATTRACT},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_NINJASK_1] = {
        ...
        .moves = {MOVE_FURYCUTTER, MOVE_SCREECH, MOVE_SWORDSDANCE, MOVE_DOUBLETEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_NINJASK_2] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_FURYCUTTER, MOVE_DOUBLETEAM, MOVE_SCREECH, MOVE_SANDATTACK},
    ...
    [SLATEPORT_TENT_MON_GRAVELER] = {
        ...
        .moves = {MOVE_MUDSPORT, MOVE_BLOCK, MOVE_ROCKTOMB, MOVE_MAGNITUDE},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_BALTOY] = {
        ...
        .moves = {MOVE_SELFDESTRUCT, MOVE_ANCIENTPOWER, MOVE_PSYBEAM, MOVE_REFLECT},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_MIGHTYENA_2] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_ODORSLEUTH, MOVE_HOWL, MOVE_SANDATTACK, MOVE_POISONFANG},
    ...
    [SLATEPORT_TENT_MON_LINOONE] = {
        ...
        .moves = {MOVE_HEADBUTT, MOVE_TICKLE, MOVE_TAILWHIP, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_GOLDEEN] = {
        ...
        .moves = {MOVE_WATERSPORT, MOVE_HORNATTACK, MOVE_WATERFALL, MOVE_SUPERSONIC},
    ...
    [SLATEPORT_TENT_MON_ARON_1] = {
        ...
        .moves = {MOVE_DIG, MOVE_METALCLAW, MOVE_IRONDEFENSE, MOVE_ENDEAVOR},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_NAUGHTY
    },
    [SLATEPORT_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_MUDSLAP, MOVE_IRONTAIL, MOVE_HARDEN, MOVE_ROAR},
    ...
    [SLATEPORT_TENT_MON_TRAPINCH_1] = {
        ...
        .moves = {MOVE_BODYSLAM, MOVE_FOCUSENERGY, MOVE_SANDTOMB, MOVE_SANDATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BRAVE
    },
    [SLATEPORT_TENT_MON_CACNEA_2] = {
        .species = SPECIES_CACNEA,
        .moves = {MOVE_INGRAIN, MOVE_SANDSTORM, MOVE_POISONSTING, MOVE_DESTINYBOND},
    ...
    [SLATEPORT_TENT_MON_TAILLOW] = {
        ...
        .moves = {MOVE_GROWL, MOVE_AERIALACE, MOVE_AGILITY, MOVE_ENDEAVOR},
    ...
    [SLATEPORT_TENT_MON_SWELLOW] = {
        ...
        .moves = {MOVE_SUPERSONIC, MOVE_GROWL, MOVE_FOCUSENERGY, MOVE_PECK},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH
    },
    [SLATEPORT_TENT_MON_GOLBAT_1] = {
        ...
        .moves = {MOVE_ASTONISH, MOVE_GUST, MOVE_MEANLOOK, MOVE_CONFUSERAY},
    ...
    [SLATEPORT_TENT_MON_SPINDA] = {
        ...
        .moves = {MOVE_DIZZYPUNCH, MOVE_FEINTATTACK, MOVE_HYPNOSIS, MOVE_REST},
    ...
    [SLATEPORT_TENT_MON_MAGNEMITE] = {
        ...
        .moves = {MOVE_METALSOUND, MOVE_SUPERSONIC, MOVE_THUNDERWAVE, MOVE_SPARK},
    ...
    [SLATEPORT_TENT_MON_WHISMUR] = {
        ...
        .moves = {MOVE_REST, MOVE_SLEEPTALK, MOVE_HOWL, MOVE_BODYSLAM},
    ...
    [SLATEPORT_TENT_MON_MAKUHITA] = {
        ...
        .moves = {MOVE_SANDATTACK, MOVE_KNOCKOFF, MOVE_ARMTHRUST, MOVE_BELLYDRUM},
    ...
    [SLATEPORT_TENT_MON_NUMEL_1] = {
        ...
        .moves = {MOVE_EMBER, MOVE_TAKEDOWN, MOVE_GROWL, MOVE_FOCUSENERGY},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_BARBOACH] = {
        ...
        .moves = {MOVE_MAGNITUDE, MOVE_MUDSPORT, MOVE_WATERSPORT, MOVE_WATERGUN},
    ...
    [SLATEPORT_TENT_MON_TENTACOOL] = {
        ...
        .moves = {MOVE_SCREECH, MOVE_BUBBLEBEAM, MOVE_ACID, MOVE_BARRIER},
    ...
    [SLATEPORT_TENT_MON_VIGOROTH] = {
        ...
        .moves = {MOVE_FOCUSENERGY, MOVE_FURYSWIPES, MOVE_ENDURE, MOVE_YAWN},
    ...
    [SLATEPORT_TENT_MON_SEVIPER_1] = {
        ...
        .moves = {MOVE_LICK, MOVE_POISONFANG, MOVE_GLARE, MOVE_WRAP},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_SOLROCK] = {
        ...
        .moves = {MOVE_ROCKTHROW, MOVE_HARDEN, MOVE_PSYWAVE, MOVE_TACKLE},
    ...
    [SLATEPORT_TENT_MON_KECLEON_1] = {
        ...
        .moves = {MOVE_PSYBEAM, MOVE_SUBSTITUTE, MOVE_THIEF, MOVE_TAILWHIP},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_KECLEON_2] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_FEINTATTACK, MOVE_ASTONISH, MOVE_LICK, MOVE_SCREECH},
    ...
    [SLATEPORT_TENT_MON_SHROOMISH_1] = {
        ...
        .moves = {MOVE_STUNSPORE, MOVE_TACKLE, MOVE_LEECHSEED, MOVE_MEGADRAIN},
    ...
    [SLATEPORT_TENT_MON_SHROOMISH_2] = {
        .species = SPECIES_SHROOMISH,
        .moves = {MOVE_ABSORB, MOVE_STUNSPORE, MOVE_SPORE, MOVE_LEECHSEED},
    ...
    [SLATEPORT_TENT_MON_LOMBRE_2] = {
        .species = SPECIES_LOMBRE,
        .moves = {MOVE_NATUREPOWER, MOVE_ASTONISH, MOVE_GROWL, MOVE_ABSORB},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_LONELY
    },
    [SLATEPORT_TENT_MON_NUMEL_2] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_EMBER, MOVE_GROWL, MOVE_EARTHQUAKE, MOVE_SUNNYDAY},
    ...
    [SLATEPORT_TENT_MON_TRAPINCH_2] = {
        .species = SPECIES_TRAPINCH,
        .moves = {MOVE_FEINTATTACK, MOVE_DIG, MOVE_BITE, MOVE_QUICKATTACK},
    ...
    [SLATEPORT_TENT_MON_PELIPPER_2] = {
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_WINGATTACK, MOVE_SUPERSONIC, MOVE_MIST, MOVE_AGILITY},
    ...
    [SLATEPORT_TENT_MON_WINGULL_2] = {
        .species = SPECIES_WINGULL,
        .moves = {MOVE_WATERGUN, MOVE_SUPERSONIC, MOVE_GROWL, MOVE_ICYWIND},
    ...
    [SLATEPORT_TENT_MON_MARILL_2] = {
        .species = SPECIES_MARILL,
        .moves = {MOVE_DOUBLEEDGE, MOVE_RAINDANCE, MOVE_TAILWHIP, MOVE_WATERGUN},
    ...
    [SLATEPORT_TENT_MON_SEVIPER_2] = {
        .species = SPECIES_SEVIPER,
        .moves = {MOVE_SWAGGER, MOVE_WRAP, MOVE_POISONTAIL, MOVE_HAZE},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_BRAVE
    },
    [SLATEPORT_TENT_MON_GOLBAT_2] = {
        .species = SPECIES_GOLBAT,
        .moves = {MOVE_BITE, MOVE_TORMENT, MOVE_SCREECH, MOVE_POISONFANG},
    ...
    [SLATEPORT_TENT_MON_RALTS] = {
        ...
        .moves = {MOVE_HYPNOSIS, MOVE_IMPRISON, MOVE_PSYCHIC, MOVE_DREAMEATER},
    ...
    [SLATEPORT_TENT_MON_SANDSHREW] = {
        ...
        .moves = {MOVE_SLASH, MOVE_SANDATTACK, MOVE_SANDTOMB, MOVE_DEFENSECURL},
    ...
    [SLATEPORT_TENT_MON_VOLBEAT] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_CONFUSERAY, MOVE_QUICKATTACK, MOVE_DOUBLETEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_KIRLIA] = {
        ...
        .moves = {MOVE_CALMMIND, MOVE_CONFUSION, MOVE_DOUBLETEAM, MOVE_GROWL},
    ...
    [SLATEPORT_TENT_MON_BRELOOM] = {
        ...
        .moves = {MOVE_ABSORB, MOVE_TACKLE, MOVE_STUNSPORE, MOVE_MEGADRAIN},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_NAIVE
    },
    [SLATEPORT_TENT_MON_PLUSLE_1] = {
        ...
        .moves = {MOVE_SPARK, MOVE_ENCORE, MOVE_THUNDERWAVE, MOVE_GROWL},
    ...
    [SLATEPORT_TENT_MON_PLUSLE_2] = {
        .species = SPECIES_PLUSLE,
        .moves = {MOVE_SPARK, MOVE_FAKETEARS, MOVE_SUBSTITUTE, MOVE_QUICKATTACK},
    ...
    [SLATEPORT_TENT_MON_ELECTRIKE_2] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_SPARK, MOVE_CHARGE, MOVE_ROAR, MOVE_THUNDERWAVE},
    ...
    [SLATEPORT_TENT_MON_SWABLU] = {
        ...
        .moves = {MOVE_SING, MOVE_PECK, MOVE_STEELWING, MOVE_SAFEGUARD},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_JOLLY
    },
    [SLATEPORT_TENT_MON_MACHOP] = {
        ...
        .moves = {MOVE_FOCUSENERGY, MOVE_VITALTHROW, MOVE_SEISMICTOSS, MOVE_FORESIGHT},
    ...
    [SLATEPORT_TENT_MON_MACHOKE] = {
        ...
        .moves = {MOVE_FOCUSENERGY, MOVE_LEER, MOVE_KARATECHOP, MOVE_FORESIGHT},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    }
...
const struct BattleFrontierTrainer gVerdanturfBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    [VERDANTURF_TENT_TRAINER_BRENNA] = {
        ...
        .speechBefore = {EC_WORD_NO, EC_WORD_DAYS, EC_WORD_GO, EC_WORD_WITHOUT, EC_WORD_MY, EC_MOVE(FAKETEARS)},
    ...
    [VERDANTURF_TENT_TRAINER_MARKUS] = {
        ...
        .speechBefore = {EC_WORD_I_AM, EC_WORD_SMART, EC_WORD_EXCL, EC_WORD_IF_I_LOSE, EC_WORD_I, EC_MOVE(SELFDESTRUCT)},
        .speechWin = {EC_WORD_IT_S, EC_WORD_A, EC_WORD_NON_STOP, EC_MOVE2(EXPLOSION), EC_WORD_OF, EC_WORD_JOY},
        .speechLose = {EC_WORD_I_VE, EC_WORD_LOST, EC_WORD_ELLIPSIS, EC_WORD_TIME, EC_WORD_TO, EC_MOVE(SELFDESTRUCT)},
    ...
    [VERDANTURF_TENT_TRAINER_RONALD] = {
        ...
        .speechLose = {EC_WORD_I, EC_WORD_NEED, EC_WORD_TO, EC_WORD_DO, EC_WORD_A, EC_MOVE2(BATONPASS)},
    ...
    [VERDANTURF_TENT_TRAINER_GERARD] = {
        ...
        .speechBefore = {EC_WORD_LOOK, EC_WORD_AT, EC_WORD_MY, EC_WORD_SUPER, EC_MOVE2(TEETERDANCE), EC_WORD_EXCL},
    ...
    [VERDANTURF_TENT_TRAINER_KENZIE] = {
        ...
        .speechBefore = {EC_WORD_THE, EC_MOVE(MORNINGSUN), EC_WORD_GIVES, EC_WORD_ME, EC_MOVE(STRENGTH), -1},
...
const struct FacilityMon gVerdanturfBattleTentMons[NUM_VERDANTURF_TENT_MONS] =
{
    ...
    [VERDANTURF_TENT_MON_ZIGZAGOON] = {
        .species = SPECIES_ZIGZAGOON,
        .moves = {MOVE_COVET, MOVE_GROWL, MOVE_PINMISSILE, MOVE_MUDSPORT},
        .itemTableId = BATTLE_FRONTIER_ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [VERDANTURF_TENT_MON_TAILLOW] = {
        .species = SPECIES_TAILLOW,
        .moves = {MOVE_AGILITY, MOVE_DOUBLETEAM, MOVE_WINGATTACK, MOVE_GROWL},
        .itemTableId = BATTLE_FRONTIER_ITEM_ORAN_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
    ...
    [VERDANTURF_TENT_MON_SHROOMISH] = {
        .species = SPECIES_SHROOMISH,
        .moves = {MOVE_HEADBUTT, MOVE_STUNSPORE, MOVE_LEECHSEED, MOVE_FLASH},
        .itemTableId = BATTLE_FRONTIER_ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,
        .nature = NATURE_RASH
    },
    [VERDANTURF_TENT_MON_MACHOP] = {
        .species = SPECIES_MACHOP,
        .moves = {MOVE_LOWKICK, MOVE_LEER, MOVE_FOCUSENERGY, MOVE_ENCORE},
        .itemTableId = BATTLE_FRONTIER_ITEM_PERSIM_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_LONELY
    },
    ...
    [VERDANTURF_TENT_MON_BARBOACH] = {
        .species = SPECIES_BARBOACH,
        .moves = {MOVE_MUDSLAP, MOVE_WATERGUN, MOVE_RAINDANCE, MOVE_SPARK},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SPEED,
        .nature = NATURE_HASTY
    },
    [VERDANTURF_TENT_MON_WINGULL] = {
        .species = SPECIES_WINGULL,
        .moves = {MOVE_ATTRACT, MOVE_TWISTER, MOVE_WINGATTACK, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_DRAGON_FANG,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_IMPISH
    },
    [VERDANTURF_TENT_MON_ARON_1] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_ENDEAVOR, MOVE_METALCLAW, MOVE_TACKLE, MOVE_ATTRACT},
        .itemTableId = BATTLE_FRONTIER_ITEM_PECHA_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HARDY
    },
    [VERDANTURF_TENT_MON_NUMEL_1] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_EMBER, MOVE_ROCKSLIDE, MOVE_ROLLOUT, MOVE_GROWL},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHARCOAL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_SASSY
    },
    [VERDANTURF_TENT_MON_SWALOT] = {
        .species = SPECIES_SWALOT,
        .moves = {MOVE_YAWN, MOVE_SLUDGE, MOVE_ACIDARMOR, MOVE_AMNESIA},
        .itemTableId = BATTLE_FRONTIER_ITEM_POISON_BARB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    [VERDANTURF_TENT_MON_KECLEON] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_SUBSTITUTE, MOVE_FEINTATTACK, MOVE_DOUBLETEAM, MOVE_BIND},
        .itemTableId = BATTLE_FRONTIER_ITEM_LAX_INCENSE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIET
    },
    [VERDANTURF_TENT_MON_BALTOY] = {
        .species = SPECIES_BALTOY,
        .moves = {MOVE_SANDSTORM, MOVE_FLASH, MOVE_SELFDESTRUCT, MOVE_HARDEN},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_NINJASK] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_DIG, MOVE_SCREECH, MOVE_SWORDSDANCE, MOVE_LEECHLIFE},
        .itemTableId = BATTLE_FRONTIER_ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    [VERDANTURF_TENT_MON_MAKUHITA] = {
        .species = SPECIES_MAKUHITA,
        .moves = {MOVE_BULKUP, MOVE_ARMTHRUST, MOVE_SMELLINGSALTS, MOVE_SANDATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SALAC_BERRY,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_SWABLU] = {
        .species = SPECIES_SWABLU,
        .moves = {MOVE_REFRESH, MOVE_SAFEGUARD, MOVE_ATTRACT, MOVE_MIRRORMOVE},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MILD
    },
    [VERDANTURF_TENT_MON_GOLDEEN_1] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_WATERFALL, MOVE_MUDSPORT, MOVE_SUPERSONIC, MOVE_DOUBLETEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_MYSTIC_WATER,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
    ...
    [VERDANTURF_TENT_MON_LOTAD] = {
        .species = SPECIES_LOTAD,
        .moves = {MOVE_GROWL, MOVE_WATERGUN, MOVE_MEGADRAIN, MOVE_PROTECT},
        .itemTableId = BATTLE_FRONTIER_ITEM_IAPAPA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_NUMEL_2] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_MAGNITUDE, MOVE_EMBER, MOVE_GROWL, MOVE_DEFENSECURL},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHARCOAL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_RELAXED
    },
    ...
    [VERDANTURF_TENT_MON_SEVIPER] = {
        .species = SPECIES_SEVIPER,
        .moves = {MOVE_WRAP, MOVE_GLARE, MOVE_POISONFANG, MOVE_SWAGGER},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    [VERDANTURF_TENT_MON_SKARMORY] = {
        ...
        .moves = {MOVE_AIRCUTTER, MOVE_SANDSTORM, MOVE_LEER, MOVE_AGILITY},
    ...
    [VERDANTURF_TENT_MON_SWELLOW] = {
        .species = SPECIES_SWELLOW,
        .moves = {MOVE_AGILITY, MOVE_WINGATTACK, MOVE_DOUBLETEAM, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_SHARP_BEAK,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_GOLDEEN_2] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_PECK, MOVE_SUPERSONIC, MOVE_PSYBEAM, MOVE_RAINDANCE},
    ...
    [VERDANTURF_TENT_MON_ELECTRIKE] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_SHOCKWAVE, MOVE_TACKLE, MOVE_CHARGE, MOVE_THUNDERWAVE},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_MILD
    },
    [VERDANTURF_TENT_MON_NUZLEAF] = {
        .species = SPECIES_NUZLEAF,
        .moves = {MOVE_SUNNYDAY, MOVE_TORMENT, MOVE_FAKEOUT, MOVE_THIEF},
        .itemTableId = BATTLE_FRONTIER_ITEM_BLACK_GLASSES,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    [VERDANTURF_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_TAKEDOWN, MOVE_METALCLAW, MOVE_IRONDEFENSE, MOVE_ATTRACT},
        .itemTableId = BATTLE_FRONTIER_ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [VERDANTURF_TENT_MON_MIGHTYENA] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_HOWL, MOVE_TAKEDOWN, MOVE_ODORSLEUTH, MOVE_SANDATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_SOLROCK] = {
        .species = SPECIES_SOLROCK,
        .moves = {MOVE_HARDEN, MOVE_FIRESPIN, MOVE_MIMIC, MOVE_PSYWAVE},
        .itemTableId = BATTLE_FRONTIER_ITEM_TWISTED_SPOON,
    ...
    [VERDANTURF_TENT_MON_GRAVELER] = {
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_ROLLOUT, MOVE_ROCKSMASH, MOVE_SANDSTORM, MOVE_BLOCK},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_IMPISH
    },
    ...
    [VERDANTURF_TENT_MON_VOLTORB] = {
        .species = SPECIES_VOLTORB,
        .moves = {MOVE_PROTECT, MOVE_SELFDESTRUCT, MOVE_SPARK, MOVE_SCREECH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_BASHFUL
    },
    [VERDANTURF_TENT_MON_MAGNEMITE] = {
        .species = SPECIES_MAGNEMITE,
        .moves = {MOVE_METALSOUND, MOVE_SUPERSONIC, MOVE_THUNDERWAVE, MOVE_SHOCKWAVE},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGNET,
    ...
    [VERDANTURF_TENT_MON_PELIPPER] = {
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_WINGATTACK, MOVE_MIST, MOVE_AGILITY, MOVE_PROTECT},
        .itemTableId = BATTLE_FRONTIER_ITEM_FIGY_BERRY,
        .evSpread = 0,
        .nature = NATURE_BRAVE
    },
    ...
    [VERDANTURF_TENT_MON_TRAPINCH] = {
        .species = SPECIES_TRAPINCH,
        .moves = {MOVE_DIG, MOVE_ROCKTOMB, MOVE_SANDSTORM, MOVE_FEINTATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_TENTACOOL] = {
        .species = SPECIES_TENTACOOL,
        .moves = {MOVE_SCREECH, MOVE_CONFUSERAY, MOVE_WRAP, MOVE_ATTRACT},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_RELAXED
    },
    [VERDANTURF_TENT_MON_VIGOROTH] = {
        .species = SPECIES_VIGOROTH,
        .moves = {MOVE_ENCORE, MOVE_SLACKOFF, MOVE_YAWN, MOVE_SECRETPOWER},
        .itemTableId = BATTLE_FRONTIER_ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_WAILMER] = {
        .species = SPECIES_WAILMER,
        .moves = {MOVE_WATERPULSE, MOVE_ROLLOUT, MOVE_CURSE, MOVE_PROTECT},
        .itemTableId = BATTLE_FRONTIER_ITEM_WHITE_HERB,
    ...
    [VERDANTURF_TENT_MON_ILLUMISE] = {
        .species = SPECIES_ILLUMISE,
        .moves = {MOVE_TACKLE, MOVE_SWEETSCENT, MOVE_WISH, MOVE_ENCORE},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_MACHOKE] = {
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_LEER, MOVE_KARATECHOP, MOVE_BULKUP, MOVE_REST},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_CALM
    },
    [VERDANTURF_TENT_MON_WHISMUR] = {
        .species = SPECIES_WHISMUR,
        .moves = {MOVE_SECRETPOWER, MOVE_SUPERSONIC, MOVE_STOMP, MOVE_ROAR},
        .itemTableId = BATTLE_FRONTIER_ITEM_RAWST_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_CACNEA] = {
        .species = SPECIES_CACNEA,
        .moves = {MOVE_INGRAIN, MOVE_LEECHSEED, MOVE_NEEDLEARM, MOVE_GROWTH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SERIOUS
    }
...
const struct BattleFrontierTrainer gFallarborBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [FALLARBOR_TENT_TRAINER_HECTER] = {
        ...
        .speechBefore = {EC_WORD_MY, EC_MOVE2(HIDDENPOWER), EC_WORD_IS, EC_WORD_EXCITING, EC_WORD_ME, EC_WORD_EXCL},
        .speechWin = {EC_WORD_YEEHAW_EXCL, EC_WORD_LET_S, EC_WORD_HAVE, EC_WORD_A, EC_MOVE2(HIDDENPOWER), EC_WORD_PARTY},
...
const struct FacilityMon gFallarborBattleTentMons[NUM_FALLARBOR_TENT_MONS] =
{
    [FALLARBOR_TENT_MON_NUMEL] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_GROWL, MOVE_FLAMETHROWER, MOVE_TACKLE, MOVE_SUNNYDAY},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHARCOAL,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_LINOONE_1] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_ODORSLEUTH, MOVE_COVET, MOVE_ROCKSMASH, MOVE_CHARM},
        .itemTableId = BATTLE_FRONTIER_ITEM_SILK_SCARF,
    ...
    [FALLARBOR_TENT_MON_PLUSLE] = {
        .species = SPECIES_PLUSLE,
        .moves = {MOVE_SPARK, MOVE_GROWL, MOVE_QUICKATTACK, MOVE_FAKETEARS},
        .itemTableId = BATTLE_FRONTIER_ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_POOCHYENA] = {
        .species = SPECIES_POOCHYENA,
        .moves = {MOVE_YAWN, MOVE_ODORSLEUTH, MOVE_HOWL, MOVE_FRUSTRATION},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEPPA_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAUGHTY
    },
    [FALLARBOR_TENT_MON_KECLEON] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_LICK, MOVE_SLASH, MOVE_FEINTATTACK, MOVE_PSYBEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_WIKI_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_MODEST
    },
    ...
    [FALLARBOR_TENT_MON_SOLROCK] = {
        .species = SPECIES_SOLROCK,
        .moves = {MOVE_ROCKTHROW, MOVE_FLASH, MOVE_SANDSTORM, MOVE_PSYWAVE},
        .itemTableId = BATTLE_FRONTIER_ITEM_HARD_STONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_SASSY
    },
    [FALLARBOR_TENT_MON_MAKUHITA] = {
        .species = SPECIES_MAKUHITA,
        .moves = {MOVE_DETECT, MOVE_ARMTHRUST, MOVE_FAKEOUT, MOVE_SMELLINGSALTS},
        .itemTableId = BATTLE_FRONTIER_ITEM_BLACK_BELT,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_MACHOKE] = {
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_COUNTER, MOVE_REVENGE, MOVE_BULKUP, MOVE_FOCUSENERGY},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_NAIVE
    },
    [FALLARBOR_TENT_MON_NINCADA] = {
        ...
        .moves = {MOVE_FURYSWIPES, MOVE_ENDURE, MOVE_MUDSLAP, MOVE_DIG},
        .itemTableId = BATTLE_FRONTIER_ITEM_LUM_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_SERIOUS
    },
    [FALLARBOR_TENT_MON_BEAUTIFLY] = {
        .species = SPECIES_BEAUTIFLY,
        .moves = {MOVE_FLASH, MOVE_MORNINGSUN, MOVE_HARDEN, MOVE_MEGADRAIN},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
    ...
    [FALLARBOR_TENT_MON_DUSTOX] = {
        .species = SPECIES_DUSTOX,
        .moves = {MOVE_MOONLIGHT, MOVE_HARDEN, MOVE_POISONSTING, MOVE_PSYBEAM},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE,
        .nature = NATURE_DOCILE
    },
    ...
    [FALLARBOR_TENT_MON_VOLBEAT] = {
        .species = SPECIES_VOLBEAT,
        .moves = {MOVE_TACKLE, MOVE_MOONLIGHT, MOVE_SIGNALBEAM, MOVE_TAILGLOW},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEPPA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_NINJASK_1] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_DOUBLETEAM, MOVE_PROTECT, MOVE_DIG, MOVE_SANDATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_TIMID
    },
    [FALLARBOR_TENT_MON_NINJASK_2] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_SWORDSDANCE, MOVE_CUT, MOVE_FURYCUTTER, MOVE_LEECHLIFE},
        .itemTableId = BATTLE_FRONTIER_ITEM_SILVER_POWDER,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_ARON_1] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_METALCLAW, MOVE_PROTECT, MOVE_SHOCKWAVE, MOVE_METALSOUND},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_LONELY
    },
    [FALLARBOR_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_SECRETPOWER, MOVE_METALCLAW, MOVE_IRONDEFENSE, MOVE_MUDSLAP},
        .itemTableId = BATTLE_FRONTIER_ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_GENTLE
    },
    [FALLARBOR_TENT_MON_ELECTRIKE] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_CRUNCH, MOVE_THUNDERWAVE, MOVE_HOWL, MOVE_QUICKATTACK},
        .itemTableId = BATTLE_FRONTIER_ITEM_SEA_INCENSE,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HASTY
    },
    [FALLARBOR_TENT_MON_MAGNEMITE] = {
        .species = SPECIES_MAGNEMITE,
        .moves = {MOVE_THUNDERWAVE, MOVE_SUPERSONIC, MOVE_ENDURE, MOVE_SPARK},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGNET,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_VOLTORB] = {
        .species = SPECIES_VOLTORB,
        .moves = {MOVE_CHARGE, MOVE_SPARK, MOVE_SCREECH, MOVE_SONICBOOM},
        .itemTableId = BATTLE_FRONTIER_ITEM_ASPEAR_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_WHISMUR] = {
        .species = SPECIES_WHISMUR,
        .moves = {MOVE_REST, MOVE_SLEEPTALK, MOVE_HYPERVOICE, MOVE_ATTRACT},
        .itemTableId = BATTLE_FRONTIER_ITEM_LAX_INCENSE,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    ...
    [FALLARBOR_TENT_MON_LINOONE_2] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_FURYSWIPES, MOVE_SANDATTACK, MOVE_SHOCKWAVE, MOVE_GROWL},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGNET,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_MIGHTYENA] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_SANDATTACK, MOVE_HOWL, MOVE_SWAGGER, MOVE_SECRETPOWER},
        .itemTableId = BATTLE_FRONTIER_ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_JOLLY
    },
    [FALLARBOR_TENT_MON_SWABLU] = {
        .species = SPECIES_SWABLU,
        .moves = {MOVE_TAKEDOWN, MOVE_SING, MOVE_GROWL, MOVE_SAFEGUARD},
        .itemTableId = BATTLE_FRONTIER_ITEM_FOCUS_BAND,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_QUIRKY
    },
    [FALLARBOR_TENT_MON_SKARMORY] = {
        .species = SPECIES_SKARMORY,
        .moves = {MOVE_AGILITY, MOVE_STEELWING, MOVE_SANDATTACK, MOVE_TORMENT},
        .itemTableId = BATTLE_FRONTIER_ITEM_METAL_COAT,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    [FALLARBOR_TENT_MON_GOLBAT] = {
        .species = SPECIES_GOLBAT,
        .moves = {MOVE_CONFUSERAY, MOVE_BITE, MOVE_DOUBLETEAM, MOVE_SUBSTITUTE},
        .itemTableId = BATTLE_FRONTIER_ITEM_PETAYA_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_BOLD
    },
    [FALLARBOR_TENT_MON_WINGULL] = {
        .species = SPECIES_WINGULL,
        .moves = {MOVE_WINGATTACK, MOVE_HAIL, MOVE_DOUBLETEAM, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_RAWST_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_PELIPPER] = {
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_TWISTER, MOVE_ICYWIND, MOVE_DOUBLETEAM, MOVE_WATERGUN},
        .itemTableId = BATTLE_FRONTIER_ITEM_DRAGON_FANG,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_BARBOACH] = {
        .species = SPECIES_BARBOACH,
        .moves = {MOVE_SPARK, MOVE_WATERGUN, MOVE_EARTHQUAKE, MOVE_WATERSPORT},
        .itemTableId = BATTLE_FRONTIER_ITEM_LIECHI_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_WAILMER] = {
        .species = SPECIES_WAILMER,
        .moves = {MOVE_WATERPULSE, MOVE_RAINDANCE, MOVE_SPLASH, MOVE_CURSE},
        .itemTableId = BATTLE_FRONTIER_ITEM_KINGS_ROCK,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_MARILL] = {
        .species = SPECIES_MARILL,
        .moves = {MOVE_DEFENSECURL, MOVE_ROLLOUT, MOVE_BUBBLEBEAM, MOVE_ATTRACT},
        .itemTableId = BATTLE_FRONTIER_ITEM_HARD_STONE,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_GOLDEEN_1] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_WATERFALL, MOVE_RAINDANCE, MOVE_FLAIL, MOVE_PROTECT},
        .itemTableId = BATTLE_FRONTIER_ITEM_GANLON_BERRY,
        .evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,
        .nature = NATURE_HASTY
    },
    [FALLARBOR_TENT_MON_GOLDEEN_2] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_SLEEPTALK, MOVE_HORNDRILL, MOVE_REST, MOVE_SUPERSONIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_MENTAL_HERB,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_CAREFUL
    },
    [FALLARBOR_TENT_MON_TRAPINCH] = {
        .species = SPECIES_TRAPINCH,
        .moves = {MOVE_RETURN, MOVE_SANDATTACK, MOVE_ATTRACT, MOVE_STRENGTH},
        .itemTableId = BATTLE_FRONTIER_ITEM_MAGO_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_BALTOY] = {
        .species = SPECIES_BALTOY,
        .moves = {MOVE_SELFDESTRUCT, MOVE_SANDSTORM, MOVE_RAPIDSPIN, MOVE_MIMIC},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
    ...
    [FALLARBOR_TENT_MON_GRAVELER] = {
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_ROCKBLAST, MOVE_DEFENSECURL, MOVE_MAGNITUDE, MOVE_MUDSPORT},
        .itemTableId = BATTLE_FRONTIER_ITEM_HARD_STONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_SANDSHREW] = {
        .species = SPECIES_SANDSHREW,
        .moves = {MOVE_SANDTOMB, MOVE_SANDSTORM, MOVE_DOUBLETEAM, MOVE_FOCUSPUNCH},
        .itemTableId = BATTLE_FRONTIER_ITEM_SOFT_SAND,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_JOLLY
    },
    [FALLARBOR_TENT_MON_SWALOT] = {
        .species = SPECIES_SWALOT,
        .moves = {MOVE_YAWN, MOVE_ENCORE, MOVE_BULLETSEED, MOVE_SLUDGE},
        .itemTableId = BATTLE_FRONTIER_ITEM_SCOPE_LENS,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_BRAVE
    },
    [FALLARBOR_TENT_MON_SHROOMISH] = {
        .species = SPECIES_SHROOMISH,
        .moves = {MOVE_HEADBUTT, MOVE_SPORE, MOVE_SWAGGER, MOVE_LEECHSEED},
        .itemTableId = BATTLE_FRONTIER_ITEM_QUICK_CLAW,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH
    },
    [FALLARBOR_TENT_MON_KIRLIA] = {
        .species = SPECIES_KIRLIA,
        .moves = {MOVE_HYPNOSIS, MOVE_GROWL, MOVE_ATTRACT, MOVE_DREAMEATER},
        .itemTableId = BATTLE_FRONTIER_ITEM_SITRUS_BERRY,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_LOMBRE] = {
        .species = SPECIES_LOMBRE,
        .moves = {MOVE_NATUREPOWER, MOVE_WATERGUN, MOVE_RAINDANCE, MOVE_FLASH},
        .itemTableId = BATTLE_FRONTIER_ITEM_LEFTOVERS,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_BASHFUL
    },
    [FALLARBOR_TENT_MON_NUZLEAF] = {
        .species = SPECIES_NUZLEAF,
        .moves = {MOVE_NATUREPOWER, MOVE_TORMENT, MOVE_SWAGGER, MOVE_REST},
        .itemTableId = BATTLE_FRONTIER_ITEM_CHESTO_BERRY,
        .evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_CACNEA] = {
        .species = SPECIES_CACNEA,
        .moves = {MOVE_SANDSTORM, MOVE_NEEDLEARM, MOVE_TEETERDANCE, MOVE_LEECHSEED},
        .itemTableId = BATTLE_FRONTIER_ITEM_BRIGHT_POWDER,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SPEED | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT
    }
