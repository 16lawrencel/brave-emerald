...
static const bool8 sValidApprenticeMoves[MOVES_COUNT] =
{
    [MOVE_NONE] = FALSE,
    [MOVE_POUND] = FALSE,
    [MOVE_KARATECHOP] = TRUE,
    [MOVE_DOUBLESLAP] = TRUE,
    [MOVE_COMETPUNCH] = FALSE,
    [MOVE_MEGAPUNCH] = TRUE,
    [MOVE_PAYDAY] = FALSE,
    [MOVE_FIREPUNCH] = TRUE,
    [MOVE_ICEPUNCH] = TRUE,
    [MOVE_THUNDERPUNCH] = TRUE,
    [MOVE_SCRATCH] = FALSE,
    [MOVE_VICEGRIP] = FALSE,
    [MOVE_GUILLOTINE] = TRUE,
    [MOVE_RAZORWIND] = FALSE,
    [MOVE_SWORDSDANCE] = TRUE,
    [MOVE_CUT] = FALSE,
    [MOVE_GUST] = FALSE,
    [MOVE_WINGATTACK] = FALSE,
    [MOVE_WHIRLWIND] = TRUE,
    [MOVE_FLY] = TRUE,
    [MOVE_BIND] = TRUE,
    [MOVE_SLAM] = TRUE,
    [MOVE_VINEWHIP] = FALSE,
    [MOVE_STOMP] = TRUE,
    [MOVE_DOUBLEKICK] = TRUE,
    [MOVE_MEGAKICK] = TRUE,
    [MOVE_JUMPKICK] = TRUE,
    [MOVE_ROLLINGKICK] = TRUE,
    [MOVE_SANDATTACK] = TRUE,
    [MOVE_HEADBUTT] = TRUE,
    [MOVE_HORNATTACK] = FALSE,
    [MOVE_FURYATTACK] = FALSE,
    [MOVE_HORNDRILL] = TRUE,
    [MOVE_TACKLE] = FALSE,
    [MOVE_BODYSLAM] = TRUE,
    [MOVE_WRAP] = TRUE,
    [MOVE_TAKEDOWN] = TRUE,
    [MOVE_THRASH] = TRUE,
    [MOVE_DOUBLEEDGE] = TRUE,
    [MOVE_TAILWHIP] = FALSE,
    [MOVE_POISONSTING] = FALSE,
    [MOVE_TWINEEDLE] = TRUE,
    [MOVE_PINMISSILE] = FALSE,
    [MOVE_LEER] = FALSE,
    [MOVE_BITE] = TRUE,
    [MOVE_GROWL] = FALSE,
    [MOVE_ROAR] = TRUE,
    ...
    [MOVE_BLIZZARD] = TRUE,
    [MOVE_PSYBEAM] = TRUE,
    [MOVE_BUBBLEBEAM] = FALSE,
    [MOVE_AURORABEAM] = FALSE,
    [MOVE_HYPERBEAM] = TRUE,
    [MOVE_PECK] = FALSE,
    [MOVE_DRILLPECK] = TRUE,
    ...
    [MOVE_LOWKICK] = TRUE,
    [MOVE_COUNTER] = TRUE,
    [MOVE_SEISMICTOSS] = TRUE,
    [MOVE_STRENGTH] = TRUE,
    [MOVE_ABSORB] = FALSE,
    [MOVE_MEGADRAIN] = FALSE,
    [MOVE_LEECHSEED] = TRUE,
    [MOVE_GROWTH] = TRUE,
    [MOVE_RAZORLEAF] = TRUE,
    [MOVE_SOLARBEAM] = TRUE,
    [MOVE_POISONPOWDER] = TRUE,
    [MOVE_STUNSPORE] = TRUE,
    [MOVE_SLEEPPOWDER] = TRUE,
    [MOVE_PETALDANCE] = TRUE,
    [MOVE_STRINGSHOT] = FALSE,
    [MOVE_DRAGONRAGE] = TRUE,
    [MOVE_FIRESPIN] = TRUE,
    [MOVE_THUNDERSHOCK] = FALSE,
    [MOVE_THUNDERBOLT] = TRUE,
    [MOVE_THUNDERWAVE] = TRUE,
    [MOVE_THUNDER] = TRUE,
    [MOVE_ROCKTHROW] = FALSE,
    ...
    [MOVE_MEDITATE] = TRUE,
    [MOVE_AGILITY] = TRUE,
    [MOVE_QUICKATTACK] = TRUE,
    [MOVE_RAGE] = FALSE,
    [MOVE_TELEPORT] = FALSE,
    [MOVE_NIGHTSHADE] = TRUE,
    [MOVE_MIMIC] = TRUE,
    [MOVE_SCREECH] = TRUE,
    [MOVE_DOUBLETEAM] = TRUE,
    [MOVE_RECOVER] = TRUE,
    [MOVE_HARDEN] = TRUE,
    [MOVE_MINIMIZE] = TRUE,
    [MOVE_SMOKESCREEN] = TRUE,
    [MOVE_CONFUSERAY] = TRUE,
    [MOVE_WITHDRAW] = TRUE,
    [MOVE_DEFENSECURL] = TRUE,
    [MOVE_BARRIER] = TRUE,
    [MOVE_LIGHTSCREEN] = TRUE,
    [MOVE_HAZE] = TRUE,
    [MOVE_REFLECT] = TRUE,
    [MOVE_FOCUSENERGY] = TRUE,
    [MOVE_BIDE] = FALSE,
    [MOVE_METRONOME] = TRUE,
    [MOVE_MIRRORMOVE] = TRUE,
    [MOVE_SELFDESTRUCT] = TRUE,
    [MOVE_EGGBOMB] = TRUE,
    [MOVE_LICK] = TRUE,
    [MOVE_SMOG] = FALSE,
    [MOVE_SLUDGE] = FALSE,
    ...
    [MOVE_SWIFT] = TRUE,
    [MOVE_SKULLBASH] = TRUE,
    [MOVE_SPIKECANNON] = FALSE,
    [MOVE_CONSTRICT] = FALSE,
    [MOVE_AMNESIA] = TRUE,
    [MOVE_KINESIS] = TRUE,
    [MOVE_SOFTBOILED] = TRUE,
    [MOVE_HIGHJUMPKICK] = TRUE,
    [MOVE_GLARE] = TRUE,
    [MOVE_DREAMEATER] = TRUE,
    [MOVE_POISONGAS] = FALSE,
    [MOVE_BARRAGE] = FALSE,
    [MOVE_LEECHLIFE] = FALSE,
    [MOVE_LOVELYKISS] = TRUE,
    [MOVE_SKYATTACK] = TRUE,
    [MOVE_TRANSFORM] = TRUE,
    [MOVE_BUBBLE] = FALSE,
    [MOVE_DIZZYPUNCH] = TRUE,
    [MOVE_SPORE] = TRUE,
    [MOVE_FLASH] = TRUE,
    [MOVE_PSYWAVE] = TRUE,
    [MOVE_SPLASH] = FALSE,
    ...
    [MOVE_STRUGGLE] = TRUE,
    [MOVE_SKETCH] = TRUE,
    [MOVE_TRIPLEKICK] = TRUE,
    [MOVE_THIEF] = TRUE,
    [MOVE_SPIDERWEB] = TRUE,
    [MOVE_MINDREADER] = TRUE,
    [MOVE_NIGHTMARE] = TRUE,
    [MOVE_FLAMEWHEEL] = FALSE,
    [MOVE_SNORE] = TRUE,
    [MOVE_CURSE] = TRUE,
    [MOVE_FLAIL] = TRUE,
    [MOVE_CONVERSION2] = TRUE,
    [MOVE_AEROBLAST] = TRUE,
    [MOVE_COTTONSPORE] = TRUE,
    [MOVE_REVERSAL] = TRUE,
    [MOVE_SPITE] = TRUE,
    [MOVE_POWDERSNOW] = FALSE,
    [MOVE_PROTECT] = TRUE,
    [MOVE_MACHPUNCH] = TRUE,
    [MOVE_SCARYFACE] = TRUE,
    [MOVE_FEINTATTACK] = TRUE,
    [MOVE_SWEETKISS] = TRUE,
    [MOVE_BELLYDRUM] = TRUE,
    [MOVE_SLUDGEBOMB] = TRUE,
    [MOVE_MUDSLAP] = TRUE,
    [MOVE_OCTAZOOKA] = TRUE,
    [MOVE_SPIKES] = TRUE,
    [MOVE_ZAPCANNON] = TRUE,
    [MOVE_FORESIGHT] = TRUE,
    [MOVE_DESTINYBOND] = TRUE,
    [MOVE_PERISHSONG] = TRUE,
    [MOVE_ICYWIND] = TRUE,
    [MOVE_DETECT] = TRUE,
    [MOVE_BONERUSH] = FALSE,
    [MOVE_LOCKON] = TRUE,
    ...
    [MOVE_CHARM] = TRUE,
    [MOVE_ROLLOUT] = TRUE,
    [MOVE_FALSESWIPE] = TRUE,
    [MOVE_SWAGGER] = TRUE,
    [MOVE_MILKDRINK] = TRUE,
    [MOVE_SPARK] = FALSE,
    [MOVE_FURYCUTTER] = TRUE,
    [MOVE_STEELWING] = TRUE,
    [MOVE_MEANLOOK] = TRUE,
    [MOVE_ATTRACT] = TRUE,
    [MOVE_SLEEPTALK] = TRUE,
    ...
    [MOVE_SAFEGUARD] = TRUE,
    [MOVE_PAINSPLIT] = TRUE,
    [MOVE_SACREDFIRE] = TRUE,
    [MOVE_MAGNITUDE] = FALSE,
    [MOVE_DYNAMICPUNCH] = TRUE,
    [MOVE_MEGAHORN] = TRUE,
    [MOVE_DRAGONBREATH] = TRUE,
    [MOVE_BATONPASS] = TRUE,
    [MOVE_ENCORE] = TRUE,
    [MOVE_PURSUIT] = TRUE,
    [MOVE_RAPIDSPIN] = TRUE,
    [MOVE_SWEETSCENT] = TRUE,
    [MOVE_IRONTAIL] = TRUE,
    [MOVE_METALCLAW] = TRUE,
    [MOVE_VITALTHROW] = TRUE,
    [MOVE_MORNINGSUN] = TRUE,
    [MOVE_SYNTHESIS] = TRUE,
    [MOVE_MOONLIGHT] = TRUE,
    [MOVE_HIDDENPOWER] = TRUE,
    [MOVE_CROSSCHOP] = TRUE,
    [MOVE_TWISTER] = FALSE,
    [MOVE_RAINDANCE] = TRUE,
    [MOVE_SUNNYDAY] = TRUE,
    [MOVE_CRUNCH] = TRUE,
    [MOVE_MIRRORCOAT] = TRUE,
    [MOVE_PSYCHUP] = TRUE,
    [MOVE_EXTREMESPEED] = TRUE,
    [MOVE_ANCIENTPOWER] = TRUE,
    [MOVE_SHADOWBALL] = TRUE,
    [MOVE_FUTURESIGHT] = TRUE,
    [MOVE_ROCKSMASH] = TRUE,
    [MOVE_WHIRLPOOL] = TRUE,
    [MOVE_BEATUP] = TRUE,
    [MOVE_FAKEOUT] = TRUE,
    ...
    [MOVE_MEMENTO] = TRUE,
    [MOVE_FACADE] = TRUE,
    [MOVE_FOCUSPUNCH] = TRUE,
    [MOVE_SMELLINGSALTS] = TRUE,
    [MOVE_FOLLOWME] = TRUE,
    [MOVE_NATUREPOWER] = TRUE,
    [MOVE_CHARGE] = TRUE,
    [MOVE_TAUNT] = TRUE,
    [MOVE_HELPINGHAND] = TRUE,
    [MOVE_TRICK] = TRUE,
    [MOVE_ROLEPLAY] = TRUE,
    [MOVE_WISH] = TRUE,
    [MOVE_ASSIST] = TRUE,
    ...
    [MOVE_GRUDGE] = TRUE,
    [MOVE_SNATCH] = TRUE,
    [MOVE_SECRETPOWER] = TRUE,
    [MOVE_DIVE] = TRUE,
    [MOVE_ARMTHRUST] = FALSE,
    [MOVE_CAMOUFLAGE] = TRUE,
    [MOVE_TAILGLOW] = TRUE,
    [MOVE_LUSTERPURGE] = TRUE,
    [MOVE_MISTBALL] = TRUE,
    [MOVE_FEATHERDANCE] = TRUE,
    [MOVE_TEETERDANCE] = TRUE,
    [MOVE_BLAZEKICK] = TRUE,
    [MOVE_MUDSPORT] = TRUE,
    [MOVE_ICEBALL] = FALSE,
    [MOVE_NEEDLEARM] = TRUE,
    [MOVE_SLACKOFF] = TRUE,
    [MOVE_HYPERVOICE] = TRUE,
    [MOVE_POISONFANG] = FALSE,
    [MOVE_CRUSHCLAW] = TRUE,
    [MOVE_BLASTBURN] = TRUE,
    [MOVE_HYDROCANNON] = TRUE,
    [MOVE_METEORMASH] = TRUE,
    [MOVE_ASTONISH] = TRUE,
    [MOVE_WEATHERBALL] = TRUE,
    [MOVE_AROMATHERAPY] = TRUE,
    [MOVE_FAKETEARS] = TRUE,
    [MOVE_AIRCUTTER] = TRUE,
    [MOVE_OVERHEAT] = TRUE,
    [MOVE_ODORSLEUTH] = TRUE,
    [MOVE_ROCKTOMB] = TRUE,
    [MOVE_SILVERWIND] = TRUE,
    [MOVE_METALSOUND] = TRUE,
    [MOVE_GRASSWHISTLE] = TRUE,
    [MOVE_TICKLE] = TRUE,
    [MOVE_COSMICPOWER] = TRUE,
    [MOVE_WATERSPOUT] = TRUE,
    [MOVE_SIGNALBEAM] = TRUE,
    [MOVE_SHADOWPUNCH] = TRUE,
    [MOVE_EXTRASENSORY] = TRUE,
    [MOVE_SKYUPPERCUT] = TRUE,
    [MOVE_SANDTOMB] = TRUE,
    [MOVE_SHEERCOLD] = TRUE,
    [MOVE_MUDDYWATER] = TRUE,
    [MOVE_BULLETSEED] = FALSE,
    [MOVE_AERIALACE] = TRUE,
    [MOVE_ICICLESPEAR] = FALSE,
    [MOVE_IRONDEFENSE] = TRUE,
    [MOVE_BLOCK] = TRUE,
    [MOVE_HOWL] = TRUE,
    [MOVE_DRAGONCLAW] = TRUE,
    [MOVE_FRENZYPLANT] = TRUE,
    [MOVE_BULKUP] = TRUE,
    [MOVE_BOUNCE] = TRUE,
    [MOVE_MUDSHOT] = FALSE,
    [MOVE_POISONTAIL] = TRUE,
    [MOVE_COVET] = TRUE,
    [MOVE_VOLTTACKLE] = TRUE,
    [MOVE_MAGICALLEAF] = TRUE,
    [MOVE_WATERSPORT] = TRUE,
    [MOVE_CALMMIND] = TRUE,
    [MOVE_LEAFBLADE] = TRUE,
    [MOVE_DRAGONDANCE] = TRUE,
    [MOVE_ROCKBLAST] = FALSE,
    [MOVE_SHOCKWAVE] = TRUE,
    [MOVE_WATERPULSE] = TRUE,
    [MOVE_DOOMDESIRE] = TRUE,
    [MOVE_PSYCHOBOOST] = TRUE,
};
