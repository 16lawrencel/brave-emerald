...
const u16 gEasyChatWordsByLetter_D[] = {
    ...
    EC_WORD_DRAGON,
    EC_MOVE2(DRAGONCLAW),
    EC_MOVE2(DRAGONDANCE),
    EC_MOVE2(DRAGONRAGE),
    EC_POKEMON_NATIONAL(DRAGONAIR),
    EC_MOVE2(DRAGONBREATH),
...
const u16 gEasyChatWordsByLetter_H[] = {
    ...
    EC_WORD_HEY_QUES,
    EC_WORD_HI,
    EC_MOVE2(HIGHJUMPKICK),
    EC_WORD_HIDDEN,
    EC_MOVE2(HIDDENPOWER),
    EC_WORD_HIGH,
    EC_WORD_HIGHS,
    EC_WORD_HIM,
    EC_WORD_HIP_AND,
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    EC_MOVE2(POISONSTING),
    EC_MOVE2(POISONTAIL),
    EC_MOVE2(POISONPOWDER),
    EC_WORD_POKEBLOCK,
    EC_WORD_POKEDEX,
    EC_WORD_POKEMON,
    EC_WORD_POKENAV,
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    EC_WORD_SEEMS,
    EC_WORD_SEES,
    EC_MOVE2(SEISMICTOSS),
    EC_MOVE(SELFDESTRUCT),
    EC_WORD_SENSE,
...
const u16 gEasyChatWordsByLetter_T[] = {
    ...
    EC_WORD_THROW,
    EC_MOVE(THUNDER),
    EC_MOVE2(THUNDERWAVE),
    EC_MOVE(THUNDERBOLT),
    EC_MOVE(THUNDERPUNCH),
    EC_MOVE2(THUNDERSHOCK),
    EC_WORD_THURSDAY,
    EC_MOVE(TICKLE),
    EC_WORD_TICKLISH,
    EC_WORD_TIGHT,
