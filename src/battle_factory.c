...
{
    MOVE_SWORDSDANCE, MOVE_GROWTH, MOVE_MEDITATE, MOVE_AGILITY, MOVE_DOUBLETEAM, MOVE_HARDEN,
    MOVE_MINIMIZE, MOVE_WITHDRAW, MOVE_DEFENSECURL, MOVE_BARRIER, MOVE_FOCUSENERGY, MOVE_AMNESIA,
    MOVE_ACIDARMOR, MOVE_SHARPEN, MOVE_CONVERSION, MOVE_CONVERSION2, MOVE_BELLYDRUM, MOVE_PSYCHUP,
    MOVE_CHARGE, MOVE_SNATCH, MOVE_TAILGLOW, MOVE_COSMICPOWER, MOVE_IRONDEFENSE, MOVE_HOWL, MOVE_BULKUP, MOVE_CALMMIND, MOVE_DRAGONDANCE,
    MOVE_NONE
};

static const u16 sMoves_ImpossibleToPredict[] =
{
    MOVE_MIMIC, MOVE_METRONOME, MOVE_MIRRORMOVE, MOVE_TRANSFORM, MOVE_SUBSTITUTE, MOVE_SKETCH, MOVE_CURSE,
    MOVE_PRESENT, MOVE_FOLLOWME, MOVE_TRICK, MOVE_ROLEPLAY, MOVE_ASSIST, MOVE_SKILLSWAP, MOVE_CAMOUFLAGE,
    MOVE_NONE
};

static const u16 sMoves_WeakeningTheFoe[] =
{
    MOVE_SANDATTACK, MOVE_TAILWHIP, MOVE_LEER, MOVE_GROWL, MOVE_STRINGSHOT, MOVE_SCREECH, MOVE_SMOKESCREEN, MOVE_KINESIS,
    MOVE_FLASH, MOVE_COTTONSPORE, MOVE_SPITE, MOVE_SCARYFACE, MOVE_CHARM, MOVE_KNOCKOFF, MOVE_SWEETSCENT, MOVE_FEATHERDANCE,
    MOVE_FAKETEARS, MOVE_METALSOUND, MOVE_TICKLE,
    MOVE_NONE
};

static const u16 sMoves_HighRiskHighReturn[] =
{
    MOVE_GUILLOTINE, MOVE_HORNDRILL, MOVE_DOUBLEEDGE, MOVE_HYPERBEAM, MOVE_COUNTER, MOVE_FISSURE,
    MOVE_BIDE, MOVE_SELFDESTRUCT, MOVE_SKYATTACK, MOVE_EXPLOSION, MOVE_FLAIL, MOVE_REVERSAL, MOVE_DESTINYBOND,
    MOVE_PERISHSONG, MOVE_PAINSPLIT, MOVE_MIRRORCOAT, MOVE_MEMENTO, MOVE_GRUDGE, MOVE_FACADE, MOVE_FOCUSPUNCH,
    MOVE_BLASTBURN, MOVE_HYDROCANNON, MOVE_OVERHEAT, MOVE_FRENZYPLANT, MOVE_PSYCHOBOOST, MOVE_VOLTTACKLE,
    MOVE_NONE
};

static const u16 sMoves_Endurance[] =
{
    MOVE_MIST, MOVE_RECOVER, MOVE_LIGHTSCREEN, MOVE_HAZE, MOVE_REFLECT, MOVE_SOFTBOILED, MOVE_REST, MOVE_PROTECT,
    MOVE_DETECT, MOVE_ENDURE, MOVE_MILKDRINK, MOVE_HEALBELL, MOVE_SAFEGUARD, MOVE_BATONPASS, MOVE_MORNINGSUN,
    MOVE_SYNTHESIS, MOVE_MOONLIGHT, MOVE_SWALLOW, MOVE_WISH, MOVE_INGRAIN, MOVE_MAGICCOAT, MOVE_RECYCLE, MOVE_REFRESH,
    MOVE_MUDSPORT, MOVE_SLACKOFF, MOVE_AROMATHERAPY, MOVE_WATERSPORT,
    MOVE_NONE
};

static const u16 sMoves_SlowAndSteady[] =
{
    MOVE_SING, MOVE_SUPERSONIC, MOVE_DISABLE, MOVE_LEECHSEED, MOVE_POISONPOWDER, MOVE_STUNSPORE, MOVE_SLEEPPOWDER,
    MOVE_THUNDERWAVE, MOVE_TOXIC, MOVE_HYPNOSIS, MOVE_CONFUSERAY, MOVE_GLARE, MOVE_POISONGAS, MOVE_LOVELYKISS, MOVE_SPORE,
    MOVE_SPIDERWEB, MOVE_SWEETKISS, MOVE_SPIKES, MOVE_SWAGGER, MOVE_MEANLOOK, MOVE_ATTRACT, MOVE_ENCORE, MOVE_TORMENT,
    MOVE_FLATTER, MOVE_WILLOWISP, MOVE_TAUNT, MOVE_YAWN, MOVE_IMPRISON, MOVE_SNATCH, MOVE_TEETERDANCE, MOVE_GRASSWHISTLE, MOVE_BLOCK,
    MOVE_NONE
};

static const u16 sMoves_DependsOnTheBattlesFlow[] =
{
    MOVE_SANDSTORM, MOVE_RAINDANCE, MOVE_SUNNYDAY, MOVE_HAIL, MOVE_WEATHERBALL,
    MOVE_NONE
};
